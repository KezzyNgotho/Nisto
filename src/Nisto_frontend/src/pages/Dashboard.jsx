...
import LocalPaymentMethods from '../components/LocalPaymentMethods';
    ...
    <div className="dashboard">
      ...
      <aside className="dashboard-sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <button className={`sidebar-link${activeTab==='payments'?' active':''}`} onClick={()=>setActiveTab('payments')}><FiCreditCard /><span>Local Payments</span></button>
      ...
      <div className="dashboard-main">
        ...
        <main className="dashboard-content">
          ...
          {activeTab === 'payments' && <LocalPaymentMethods />}

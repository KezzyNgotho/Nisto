      ...
      <div style={{ 
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderRadius: 8,
            background: vaultView === 'my-vaults' ? 'linear-gradient(135deg, var(--primary-500), var(--primary-600))' : 'transparent',
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderRadius: 8,
            background: vaultView === 'public-vaults' ? 'linear-gradient(135deg, var(--primary-500), var(--primary-600))' : 'transparent',

    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: `linear-gradient(135deg, ${theme.colors.primary}10, ${theme.colors.text.primary}10)`
        }}>
          <div>
            <h2 style={{ 
              margin: 0, 
              ...
              background: `linear-gradient(135deg, ${theme.colors.primary}, ${theme.colors.text.primary})`,
          ...
          >
            {isAuthenticating || isLoading ? (
              <>
                ...
                <span style={{ color: theme.colors.primary }}>Signing In...</span>
              </>
            ) : (
              <>
                <FiGlobe size={22} style={{ color: theme.colors.primary }} />
                <span style={{ color: theme.colors.primary }}>Continue with Internet Identity</span>
              </>
            )}
          </button>

...
`);
  ...
  async syncTime(canisterId) {
    await __classPrivateFieldGet4(this, _HttpAgent_instances, "m", _HttpAgent_rootKeyGuard).call(this);
    const CanisterStatus = await import("./canisterStatus-JQTRGWR3.js");
...
var encodePath = (path, canisterId) => {
  ...
  switch (path) {
    case "time":
      return [encode3("time")];
    case "controllers":
      return [encode3("canister"), canisterBuffer, encode3("controllers")];
    case "module_hash":
      return [encode3("canister"), canisterBuffer, encode3("module_hash")];
    case "subnet":
      return [encode3("subnet")];
    case "candid":
      return [encode3("canister"), canisterBuffer, encode3("metadata"), encode3("candid:service")];
    default: {
      if ("key" in path && "path" in path) {
        if (typeof path["path"] === "string" || path["path"] instanceof ArrayBuffer) {
          const metaPath = path.path;
          const encoded = typeof metaPath === "string" ? encode3(metaPath) : metaPath;
          return [encode3("canister"), canisterBuffer, encode3("metadata"), encoded];
        } else {
          return path["path"];
        }
      }
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-NTHREDYY.js.map

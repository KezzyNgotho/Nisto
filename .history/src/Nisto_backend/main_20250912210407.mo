...
persistent actor Nisto {
 ...
 // ========== PLUGIN SYSTEM HELPER FUNCTIONS ==========
  ...
  // ===== SWAP SERVICE STORAGE =====
  private var nextSwapId: Nat = 1;
  private transient var swapHistory = HashMap.HashMap<Text, {
    id: Text;
    fromCurrency: Text;
    toCurrency: Text;
    inputAmount: Float;
  ...
  private transient var userSwapHistory = HashMap.HashMap<Principal, [Text]>(100, Principal.equal, Principal.hash);

...
Stderr:
/home/kezzy/Nesto/src/Nisto_backend/main.mo:272.9-272.10: syntax error [M0001], unexpected token ':', expected one of token or <phrase> sequence:
  <id> = <typ>
  <id> < seplist(<typ_bind>,,) > = <typ>

kezzy@DESKTOP-FTKUO7E:~/Nesto$ dfx deploy
...
Caused by: Failed while trying to deploy canisters.
  Failed to build all canisters.
    Failed while trying to build all canisters.
      The build step failed for canister 'bkyz2-fmaaa-aaaaa-qaaaq-cai' (Nisto_backend) with an embedded error: Failed to build Motoko canister 'Nisto_backend'.: Failed to compile Motoko.: Failed to run 'moc'.: The command '"/home/kezzy/.cache/dfinity/versions/0.20.0/moc" "/home/kezzy/Nesto/src/Nisto_backend/main.mo" "-o" "/home/kezzy/Nesto/.dfx/local/canisters/Nisto_backend/Nisto_backend.wasm" "-c" "--debug" "--idl" "--stable-types" "--public-metadata" "candid:service" "--public-metadata" "candid:args" "--actor-idl" "/home/kezzy/Nesto/.dfx/local/canisters/idl/" "--actor-alias" "Nisto_backend" "bkyz2-fmaaa-aaaaa-qaaaq-cai" "--actor-alias" "Nisto_frontend" "bd3sg-teaaa-aaaaa-qaaba-cai" "--actor-alias" "internet_identity" "be2us-64aaa-aaaaa-qaabq-cai" "--package" "base" "/home/kezzy/.cache/dfinity/versions/0.20.0/base"' failed with exit status 'exit status: 1'.
Stdout:

Stderr:
/home/kezzy/Nesto/src/Nisto_backend/main.mo:326.3-326.9: syntax error [M0001], unexpected token 'public', expected one of token or <phrase> sequence:
  <eof>

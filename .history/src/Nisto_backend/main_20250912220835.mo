...
persistent actor Nisto {
  ...
  var userPreferences : OrderedMap.Map<Text, UserPreferences> = textMap.empty<UserPreferences>();
 ...
 // ========== PLUGIN SYSTEM HELPER FUNCTIONS ==========
  ...
  public shared func saveUserPreferences(userId : Text, preferences : UserPreferences) : async () {
  ...
  public shared func updateUserPreferences(userId : Text, preferences : UserPreferences) : async () {

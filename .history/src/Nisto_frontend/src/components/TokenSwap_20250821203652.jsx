...
const TokenSwap = () => {
  ...
  return (
    <div className="token-form" style={{ maxWidth: '100%' }}>
      ...
      <div style={{ marginBottom: '2rem' }}>
        {/* From Token */}
        <div className="token-form-group" style={{ marginBottom: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', margin: '1rem 0' }}>
          <button
            ...
            style={{ padding: '0.75rem', borderRadius: '50%', width: '3rem', height: '3rem' }}
          >
            <FiArrowRight />
          </button>
        </div>
      ...
      {swapData.fromAmount && swapData.toAmount && (
        <div style={{ marginBottom: '2rem' }}>
          <div style={{ 
            ...
            <h4 style={{ fontSize: '1rem', fontWeight: '600', marginBottom: '1rem' }}>Swap Details</h4>

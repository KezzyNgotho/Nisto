...
const MarketInterface = () => {
  ...
  const getCurrencyIcon = (currency) => {
    switch (currency) {
      ...
      case 'USDT':
        return <div className="w-4 h-4 rounded-full bg-green-500 flex items-center justify-center text-xs text-white font-bold">T</div>;
      case 'USDC':
        return <div className="w-4 h-4 rounded-full bg-blue-500 flex items-center justify-center text-xs text-white font-bold">C</div>;
      case 'ICP':
        return <div className="w-4 h-4 rounded-full bg-purple-500 flex items-center justify-center text-xs text-white font-bold">I</div>;
      default:
        return <DollarSign className="w-4 h-4" />;
    }
  };

  ...
  return (
    <div className="swap-module">
      ...
      <div className="swap-content-grid">
            ...
            <div className="card-header">
              ...
              <div className="swap-stats">
                <div className="stat-item">
                  <span style={{ color: theme.colors.text.secondary }}>Rate</span>
                  <span style={{ color: theme.colors.text.primary }}>
                    1 {swapForm.fromCurrency} = {swapForm.rate.toFixed(6)} {swapForm.toCurrency}
                  </span>
                </div>
                <div className="stat-item">
                  <span style={{ color: theme.colors.text.secondary }}>Slippage</span>
                  <span style={{ color: theme.colors.text.primary }}>{swapForm.slippage}%</span>
                </div>
              </div>
            </div>
        ...
        {/* Right Column - Market Info & Currencies */}
          ...
          <div className="market-overview-card" style={{ 
            ...
            <div className="market-stats">
              <div className="stat-row">
                ...
                <span style={{ color: theme.colors.text.primary }}>$2.4M</span>
              </div>
              <div className="stat-row">
                <span style={{ color: theme.colors.text.secondary }}>Total Pairs</span>
                <span style={{ color: theme.colors.text.primary }}>25</span>
              </div>
              <div className="stat-row">
                <span style={{ color: theme.colors.text.secondary }}>Avg. Fee</span>
                <span style={{ color: theme.colors.text.primary }}>0.1%</span>
              </div>
            </div>
          </div>

...
const TokenDashboard = () => {
  ...
  return (
    <div className="token-dashboard token-component">
      {/* Header */}
      <div className="token-header">
        ...
        <div className="token-header-actions token-actions">
          <div className="auto-refresh-control">
            <button
              className={`token-btn token-action ${autoRefresh ? 'active' : ''}`}
          ...
          <button
            className="token-btn token-action"
        ...
        <div className="token-stats-grid">
          <div className="token-stat-card">
            <div className="token-stat-header">
              <div className="token-stat-icon" style={{ backgroundColor: `${theme.colors.primary}15` }}>
                <FiDollarSign style={{ color: theme.colors.primary }} />
              </div>
        ...
        <div className="token-tab-content">
                ...
                <div>
                  ...
                  <div className="token-info-item">
                    ...
                    <span className="token-info-value" style={{
                        color: tokenMetadata?.isPaused ? theme.colors.error : theme.colors.success
                    }}>
                ...
                <div className="token-info-card">
                  ...
                  <div>
                    <div className="token-info-item">
                      <span className="token-info-label">Status</span>
                      <span className="token-info-value" style={{
                        color: stakingInfo.isStaking ? theme.colors.success : theme.colors.text.secondary
                      }}>
          ...
          {activeTab === 'transfer' && (
            <div className="token-form">
              <h3>
                <FiSend style={{ color: theme.colors.primary }} />
          ...
          {activeTab === 'history' && (
            <div>
              <h3 style={{
                ...
                <FiClock style={{ color: theme.colors.text.secondary }} />

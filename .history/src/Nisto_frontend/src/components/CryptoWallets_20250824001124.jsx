...
const CryptoWallets = () => {
  ...
  const getNetworkInfo = (currency) => {
    const networks = {
      NST: { name: 'Nisto Network', color: theme.colors.info },
      ICP: { name: 'Internet Computer', color: theme.colors.primary },
      BTC: { name: 'Bitcoin', color: theme.colors.warning },
      ETH: { name: 'Ethereum', color: theme.colors.info }
    };
    return networks[currency] || { name: 'Unknown', color: theme.colors.text.secondary };
  };
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (result && result.ok) {
        ...
        showToast(`Transaction failed: ${result?.err || 'Unknown error'}`, 'error');
      }
    } catch (error) {
      console.error('Error sending crypto:', error);
      showToast(`Failed to send transaction: ${error.message || 'Unknown error'}`, 'error');
    }
  };
  ...
  return (
    <div className="wallet-component">
      {/* Header */}
      <div className="wallet-header" style={{ marginBottom: '2rem' }}>
        <h2 className="wallet-title" style={{ 
          fontSize: '1.5rem', 
          fontWeight: '700', 
        ...
        <p className="wallet-subtitle" style={{ 
          fontSize: '0.875rem', 
      ...
      {/* Stats Overview */}
      <div className="wallet-stats" style={{ marginBottom: '2rem' }}>
        <div className="wallet-card" style={{ 
          ...
          <h4 className="wallet-subtitle" style={{ 
            fontSize: '1rem', 
            fontWeight: '600', 
            marginBottom: '1.5rem', 
            color: theme.colors.text.primary,
          ...
          <div className="wallet-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem' }}>
            <div className="wallet-stat-card" style={{ 
              backgroundColor: theme.colors.white, 
              padding: '1rem', 
              borderRadius: '0.75rem',
              border: `1px solid ${theme.colors.border.primary}`
            }}>
              <div className="wallet-stat-label" style={{ fontSize: '0.75rem', color: theme.colors.text.secondary, marginBottom: '0.5rem' }}>Total Wallets</div>
              <div className="wallet-stat-value" style={{ fontSize: '1.25rem', fontWeight: '600', color: theme.colors.text.primary }}>
            ...
            <div className="wallet-stat-card" style={{ 
              ...
              <div className="wallet-stat-label" style={{ fontSize: '0.75rem', color: theme.colors.text.secondary, marginBottom: '0.5rem' }}>Total Balance</div>
              <div className="wallet-stat-value" style={{ fontSize: '1.25rem', fontWeight: '600', color: theme.colors.success }}>
            ...
            <div className="wallet-stat-card" style={{ 
              ...
              <div className="wallet-stat-label" style={{ fontSize: '0.75rem', color: theme.colors.text.secondary, marginBottom: '0.5rem' }}>Networks</div>
              <div className="wallet-stat-value" style={{ fontSize: '1.25rem', fontWeight: '600', color: theme.colors.primary }}>
      ...
      {/* Wallets Section */}
      <div className="wallet-section" style={{ marginBottom: '2rem' }}>
        <div className="wallet-card" style={{ 
          backgroundColor: theme.colors.interactive.secondary,
          borderRadius: '1rem',
          padding: '1.5rem',
          ...
          <div className="wallet-actions" style={{ 
            ...
            <button 
              className="wallet-btn wallet-action"
          ...
          {cryptoWallets.length === 0 ? (
            <div style={{
              ...
              <h3 style={{ margin: '0 0 0.5rem 0', fontSize: '1.125rem', fontWeight: '600', color: theme.colors.text.primary }}>
                No wallets yet
              </h3>
              <p style={{ margin: '0 0 1.5rem 0', fontSize: '0.875rem', color: theme.colors.text.secondary }}>
            ...
            return (
                  <div key={wallet.id} style={{
                    ...
                    {getWalletIcon(wallet.currency)}
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ fontSize: '1rem', fontWeight: '600', color: theme.colors.text.primary, marginBottom: '0.125rem' }}>
                          {wallet.name}
                        </div>

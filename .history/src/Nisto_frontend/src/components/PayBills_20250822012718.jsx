...
const PayBills = () => {
  ...
  useEffect(() => {
    const loadBills = async () => {
      ...
      console.log('Setting default bills:', defaultBills);

      // Try to load from backend if service exists
      if (backendService && typeof backendService.getAvailableBills === 'function') {
        try {
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        {/* Bill Selection */}
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            {console.log('Rendering bills:', availableBills)}

...
export default function GroupVaults() {
  ...
  const vaultTypeOptions = [
    { value: 'Savings', label: 'Savings Vault', icon: FiDollarSign },
    { value: 'Investment', label: 'Investment Portfolio', icon: FiTrendingUp },
    { value: 'Emergency', label: 'Emergency Fund', icon: FiAlertTriangle },
    { value: 'Travel', label: 'Travel Fund', icon: FiMapPin },
    { value: 'Education', label: 'Education Fund', icon: FiBookOpen },
    { value: 'Business', label: 'Business Capital', icon: FiBriefcase },
    { value: 'Charity', label: 'Charity Fund', icon: FiHeart },
    { value: 'Custom', label: 'Custom Goal', icon: FiFlag }
  ];
              ...
              <div>
                ...
                <select 
                  ...
                  >
                    ...
                    <option value="Charity">Charity Fund</option>

        ...
        <div className="wallet-card" style={{ 
          ...
          <div className="wallet-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem' }}>
            ...
            <div style={{ 
              ...
              <div style={{ fontSize: '0.75rem', color: theme.colors.text.secondary, marginBottom: '0.5rem' }}>Networks</div>
              <div style={{ fontSize: '1.25rem', fontWeight: '600', color: theme.colors.primary }}>

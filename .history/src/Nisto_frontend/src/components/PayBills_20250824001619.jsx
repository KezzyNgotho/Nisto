...
const PayBills = () => {
      ...
      try {
        ...
        setAvailableBills([
          ...
          },
          {
            ...
            requiresPaybill: true,
            color: '#f59e0b',
            fields: ['paybillNumber', 'accountNumber', 'meterNumber'],
            serviceIcon: '⚡'
          },
          {
            id: 'water',
          ...
          },
          {
            ...
            requiresPaybill: true,
            color: '#8b5cf6',
            fields: ['paybillNumber', 'accountNumber', 'phoneNumber'],
            serviceIcon: '🌐'
          },
                     {
             id: 'buy-goods',
          ...
          },
          {
            ...
            icon: FiTv,
            description: 'Pay TV subscription bills',
            paybillNumber: '174379',
            accountType: 'Paybill',
            status: 'active',
            requiresPaybill: true,
            color: '#f97316',
            fields: ['paybillNumber', 'accountNumber', 'packageType'],
            serviceIcon: '📺'
          },
          {
            id: 'insurance',
            ...
            requiresPaybill: true,
            color: '#059669',
            fields: ['paybillNumber', 'accountNumber', 'policyNumber'],
            serviceIcon: '🛡️'
          },
          {
            id: 'school-fees',
            name: 'School Fees',
            icon: FiBook,
            description: 'Pay school fees and education',
            paybillNumber: '174379',
            accountType: 'Paybill',
            status: 'active',
            requiresPaybill: true,
            color: '#7c3aed',
            fields: ['paybillNumber', 'accountNumber', 'studentName'],
            serviceIcon: '🎓'
          },
          {
            id: 'rent',
            name: 'Rent',
            icon: FiHome,
            description: 'Pay rent and housing',
            paybillNumber: '174379',
            accountType: 'Paybill',
            status: 'active',
            requiresPaybill: true,
            color: '#0ea5e9',
            fields: ['paybillNumber', 'accountNumber', 'propertyAddress'],
            serviceIcon: '🏠'
          }
        ]);
      }
  ...
  useEffect(() => {
    ...
    <div className="payment-component">
      {/* Header */}
      <div className="payment-header" style={{ marginBottom: '2rem' }}>
        <h2 className="payment-title" style={{ 
          fontSize: '1.5rem', 
          fontWeight: '700', 
          color: '#1e293b',
          marginBottom: '0.5rem',
        ...
        <p className="payment-subtitle" style={{ 
          fontSize: '0.875rem', 
          color: '#64748b',
          margin: 0
        }}>
      ...
      {/* Exchange Rate Card */}
      <div className="payment-exchange-rate" style={{ marginBottom: '2rem' }}>
        <div className="payment-card dashboard-card" style={{ 
          backgroundColor: '#f8fafc',
          borderRadius: '1rem',
          padding: '1.5rem',
          border: '1px solid #e2e8f0'
        }}>
          <div className="payment-card-header" style={{ 
            display: 'flex', 
            justifyContent: 'space-between', 
            alignItems: 'center',
            marginBottom: '1rem'
          }}>
            <h4 className="payment-card-title" style={{ 
              fontSize: '1rem', 
              fontWeight: '600', 
              color: '#1e293b',
              display: 'flex',
          ...
          <button 
            className="payment-refresh-btn dashboard-btn"
          ...
          <div className="payment-rate-grid dashboard-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
            <div className="payment-rate-card dashboard-card" style={{ 
              backgroundColor: 'white', 
              padding: '1rem', 
              borderRadius: '0.75rem',
              border: '1px solid #e2e8f0'
            }}>
              <div className="payment-rate-label" style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '0.5rem' }}>USDT/KES Rate</div>
              <div className="payment-rate-value" style={{ fontSize: '1.25rem', fontWeight: '600', color: '#1e293b' }}>
            ...
            {availableBills.map((bill) => (
              <div
                ...
                style={{
                  ...
                  border: `2px solid ${selectedBill?.id === bill.id ? bill.color : '#e2e8f0'}`,
                  borderRadius: '1rem',
                  padding: '1.25rem',
                  cursor: 'pointer',
        ...
        {/* Wallet Selection */}
          <div style={{ marginBottom: '1.5rem' }}>
            <label style={{ 
              ...
              <FiCreditCard size={16} style={{ color: '#3b82f6' }} />
              Select Wallet
            </label>
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <div>
                    <div style={{ fontSize: '0.75rem', color: '#059669', marginBottom: '0.25rem', fontWeight: '500' }}>KES Amount</div>
                ...
                <div style={{ 
                  ...
                  <div>
                    <div style={{ fontSize: '0.75rem', color: '#2563eb', marginBottom: '0.25rem', fontWeight: '500' }}>USDT Equivalent</div>
                ...
                {selectedWallet && walletCurrencyAmount && (
                  <div style={{ 
                    ...
                    <div>
                      <div style={{ fontSize: '0.75rem', color: '#d97706', marginBottom: '0.25rem', fontWeight: '500' }}>Wallet Amount</div>
         ...
         {selectedBill && selectedBill.requiresPaybill && (
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              {/* Meter Number for Electricity and Water */}
              {(selectedBill.id === 'electricity' || selectedBill.id === 'water') && (
                <div style={{ marginTop: '1rem' }}>
                  <label style={{ 
                    ...
                    <FiZap size={14} style={{ color: selectedBill.id === 'electricity' ? '#f59e0b' : '#3b82f6' }} />
                    Meter Number
                  </label>
                  <div style={{ position: 'relative' }}>
                    <input
              ...
              {selectedBill.id === 'internet' && (
                <div style={{ marginTop: '1rem' }}>
                  <label style={{ 
                    ...
                    <FiPhone size={14} style={{ color: '#8b5cf6' }} />
                    Phone Number
                  </label>
                  <div style={{ position: 'relative' }}>
                    <input
              ...
              {/* Package Type for TV Subscription */}
              {selectedBill.id === 'tv-subscription' && (
                <div style={{ marginTop: '1rem' }}>
                  <label style={{ 
                    display: 'block', 
                    marginBottom: '0.5rem', 
                    ...
                    <FiTv size={14} style={{ color: '#f97316' }} />
                    Package Type
                  </label>
                  <div style={{ position: 'relative' }}>
                    <select
              ...
              {selectedBill.id === 'insurance' && (
                <div style={{ marginTop: '1rem' }}>
                  <label style={{ 
                    ...
                    <FiShield size={14} style={{ color: '#059669' }} />
                    Policy Number
                  </label>
                  <div style={{ position: 'relative' }}>
                    <input
              ...
              {/* Student Name for School Fees */}
              {selectedBill.id === 'school-fees' && (
                <div style={{ marginTop: '1rem' }}>
                  <label style={{ 
                    display: 'block', 
                    marginBottom: '0.5rem', 
              ...
              {selectedBill.id === 'rent' && (
                <div style={{ marginTop: '1rem' }}>
                  <label style={{ 
                    ...
                    <FiMapPin size={14} style={{ color: '#0ea5e9' }} />
                    Property Address
                  </label>
                  <div style={{ position: 'relative' }}>
                    <input
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div>
                  <label style={{ 
                    ...
                    <FiShoppingCart size={14} style={{ color: '#ef4444' }} />
                    Till Number
                  </label>
                  <div style={{ position: 'relative' }}>
                 <input
                ...
                <div>
                  <label style={{ 
                    ...
                    <FiTag size={14} style={{ color: '#8b5cf6' }} />
                    Reference
                  </label>
                  <div style={{ position: 'relative' }}>
                    <input
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div>
                  <label style={{ 
                    ...
                    <FiPhone size={14} style={{ color: '#06b6d4' }} />
                    Recipient Phone
                  </label>
                  <div style={{ position: 'relative' }}>
                  <input
                ...
                <div>
                  <label style={{ 
                    ...
                    <FiUser size={14} style={{ color: '#06b6d4' }} />
                    Recipient Name
                  </label>
                  <div style={{ position: 'relative' }}>
                  <input
              ...
              <div style={{ marginTop: '1rem' }}>
                <label style={{ 
                  ...
                  <FiTag size={14} style={{ color: '#06b6d4' }} />
                  Reference
                </label>
                <div style={{ position: 'relative' }}>
                  <input
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div>
                  <label style={{ 
                    ...
                    <FiPhone size={14} style={{ color: '#ec4899' }} />
                    Phone Number
                  </label>
                  <div style={{ position: 'relative' }}>
                <input
                ...
                <div>
                  <label style={{ 
                    ...
                    <FiWifi size={14} style={{ color: '#ec4899' }} />
                    Network
                  </label>
                  <div style={{ position: 'relative' }}>
                    <select
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <div>
                  <label style={{ 
                    ...
                    <FiWifi size={14} style={{ color: '#8b5cf6' }} />
                    Bundle Type
                  </label>
                  <div style={{ position: 'relative' }}>
                    <select

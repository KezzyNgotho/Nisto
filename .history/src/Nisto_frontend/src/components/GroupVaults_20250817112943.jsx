                ...
                <div key={vault.id} className="vault-card" onClick={() => handleOpenVaultDetails(vault)}>
                  ...
                  <div className="vault-stats">
                    <div className="vault-stat-item">
                      <div className="vault-stat-label">Currency</div>
                      <div className="vault-stat-value currency">{vault.currency}</div>
                    </div>
                    <div className="vault-stat-item">
                      <div className="vault-stat-label">Target</div>
                      <div className="vault-stat-value target">{vault.targetAmount || 'N/A'}</div>
                    </div>
                    <div className="vault-stat-item">
                      <div className="vault-stat-label">Balance</div>
                      <div className="vault-stat-value balance">{vault.totalBalance}</div>
                    </div>
                    <div className="vault-stat-item">
                      <div className="vault-stat-label">Members</div>
                      <div className="vault-stat-value members">{vault.members ? vault.members.length : '—'}</div>
                    </div>
                  </div>
                  ...
                  <div className="vault-actions">
                    <button 
                      className="vault-action-btn primary small"

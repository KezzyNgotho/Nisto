          ...
          justifyContent: 'center',
              ...
              <button 
                style={{
                        ...
                        fontSize: '0.875rem',
                  fontWeight: 600,
                        background: `linear-gradient(135deg, ${theme.colors.background.secondary} 0%, ${theme.colors.border.primary} 100%)`,
                  ...
                  cursor: 'pointer',
                      ...
                      onMouseLeave={(e) => {
                        ...
                        e.target.style.background = `linear-gradient(135deg, ${theme.colors.background.secondary} 0%, ${theme.colors.border.primary} 100%)`;
                      }}
                    >
                      <div style={{
                        width: '20px',

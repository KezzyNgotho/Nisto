    ...
    <div style={{ width: '100%', padding: '0', margin: 0 }}>
              ...
              <div style={{
                ...
                padding: '1rem',
                    ...
                    <div style={{ textAlign: 'center', flex: 1 }}>
                      ...
                      <div style={{ fontSize: '1rem', color: theme.colors.success, fontWeight: 600, letterSpacing: '-0.025em' }}>{vault.totalBalance}</div>
                </div>
                    <div style={{ width: '1px', height: '2rem', background: theme.colors.border.secondary }} />
                    <div style={{ textAlign: 'center', flex: 1 }}>
                      ...
                      <div style={{ fontSize: '1rem', color: theme.colors.primary, fontWeight: 600, letterSpacing: '-0.025em' }}>{vault.currency}</div>
              </div>
            </div>
          ...
          justifyContent: 'center',
              ...
              <div style={{
                ...
                justifyContent: 'center',
                    ...
                    style={{
                        ...
                        fontSize: '0.875rem',
                      fontWeight: 600,
                        background: `linear-gradient(135deg, ${theme.colors.warning} 0%, ${theme.colors.warning} 100%)`,
                        border: 'none',
                        color: 'white',
                        borderRadius: '0.75rem',
                        cursor: 'pointer',
              ...
              <button 
                style={{
                        ...
                        fontSize: '0.875rem',
                  fontWeight: 600,
                        background: `linear-gradient(135deg, ${theme.colors.white} 0%, ${theme.colors.border.primary} 100%)`,
                  ...
                  cursor: 'pointer',
                        ...
                        alignItems: 'center',
                        justifyContent: 'center',
                        boxShadow: `0 2px 8px rgba(${theme.colors.black.r}, ${theme.colors.black.g}, ${theme.colors.black.b}, 0.1)`
                      }}
                      onClick={(e) => { e.stopPropagation(); handleEditOpen(vault); }}
                      onMouseEnter={(e) => {
                        e.target.style.transform = 'translateY(-2px)';
                        e.target.style.boxShadow = `0 4px 12px rgba(${theme.colors.black.r}, ${theme.colors.black.g}, ${theme.colors.black.b}, 0.15)`;
                        e.target.style.background = `linear-gradient(135deg, ${theme.colors.white} 0%, ${theme.colors.border.primary} 100%)`;
                      }}
                      onMouseLeave={(e) => {
                        e.target.style.transform = 'translateY(0)';
                        e.target.style.boxShadow = `0 2px 8px rgba(${theme.colors.black.r}, ${theme.colors.black.g}, ${theme.colors.black.b}, 0.1)`;
                        e.target.style.background = `linear-gradient(135deg, ${theme.colors.white} 0%, ${theme.colors.border.primary} 100%)`;
                      }}
                    >
                      <div style={{
      ...
      {showCreate && (
        <div style={{
          ...
          right: 0,
          bottom: 0,
          background: `rgba(${theme.colors.black.r}, ${theme.colors.black.g}, ${theme.colors.black.b}, 0.6)`,
          ...
          <form onSubmit={handleCreate} style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
              <div style={{
                width: 48,
                height: 48,
                background: `rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 1)`,
                borderRadius: '50%',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
              ...
              <h2 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 700, color: `rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 1)` }}>Create New Vault</h2>
              <p style={{ margin: '0.25rem 0 0 0', color: `rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 1)`, fontSize: '0.8rem' }}>Set up a new group vault for collaborative savings</p>
            </div>
            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div>
                  <label style={{ display: 'block', marginBottom: '0.375rem', fontWeight: 600, color: `rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 1)`, fontSize: '0.75rem' }}>Vault Name *</label>
                <input 
                  type="text" 
              ...
              <div>
                  <label style={{ display: 'block', marginBottom: '0.375rem', fontWeight: 600, color: `rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 1)`, fontSize: '0.75rem' }}>Type *</label>
                <select 
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '0.375rem', fontWeight: 600, color: `rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 1)`, fontSize: '0.75rem' }}>Currency *</label>
                  <input 
                    type="text" 
                    placeholder="KES" 
              ...
              <div>
                  <label style={{ display: 'block', marginBottom: '0.375rem', fontWeight: 600, color: `rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 1)`, fontSize: '0.75rem' }}>Target Amount</label>
                  <input 
                    type="number" 
                    placeholder="0.00" 

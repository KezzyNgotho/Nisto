            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1.5rem' }}>
              ...
              <button 
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: '0.5rem',
                  background: submitting ? `r gba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 1)` : `rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 1)`,
                  color: 'white',
                  fontSize: '0.875rem',
                  fontWeight: 600,

...
const SwapModule = ({ onBack }) => {
  ...
  const getCurrencyIcon = (currencyId) => {
    ...
    if (currency && currency.icon) {
      ...
      return <IconComponent size={20} style={{ color: theme.colors.primary }} />;
    }
        ...
        <div className="swap-interface-column">
          ...
          <div className="swap-card" style={{ 
                ...
                <div className="swap-arrow-container">
                  <button 
                    ...
                    style={{ 
                      ...
                      boxShadow: `0 4px 20px ${theme.colors.shadow?.primary || 'rgba(0, 0, 0, 0.1)'}`
                    }}
                  >
                    <FiRotateCcw />
                  </button>
            ...
            <button 
              ...
              style={{ 
                background: loading ? theme.colors.background.secondary : `linear-gradient(135deg, ${theme.colors.primary}, ${theme.colors.secondary || theme.colors.primary})`,
                color: theme.colors.text.inverse || theme.colors.white,
                border: 'none',
                boxShadow: `0 4px 20px ${theme.colors.shadow?.primary || 'rgba(0, 0, 0, 0.1)'}`
              }}

...
export default function GroupVaults() {
  ...
  return (
    <div className="vault-component" style={{ width: '100%', padding: '0', margin: 0 }}>
      ...
      <div className="vault-tabs" style={{ 
        ...
        <button
          className={`vault-tab ${vaultView === 'my-vaults' ? 'active' : ''}`}
        ...
        <button
          className={`vault-tab ${vaultView === 'public-vaults' ? 'active' : ''}`}
      ...
      {vaultView === 'public-vaults' ? (
        ...
        <div className="vault-actions" style={{
          ...
          alignItems: 'center',
            ...
            <button 
              ref={createBtnRef}
              className="vault-btn vault-action"
              style={{ 

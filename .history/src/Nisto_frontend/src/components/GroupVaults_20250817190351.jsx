                ...
                <div key={vault.id} className="vault-card" onClick={() => handleOpenVaultDetails(vault)}>
                  ...
                  <div className="vault-card-header">
                    ...
                    <div className="vault-header-content">
                      ...
                      <div className="vault-type">{String(vault.vaultType || 'Custom')}</div>
                  ...
                  <div className="vault-balance-highlight">
                    <div className="balance-amount">
                      {vault.totalBalance || 0} {vault.currency || 'USD'}
                    </div>
                    ...
                    <div className="vault-stat-item">
                      ...
                      <div className="stat-content">
                        <div className="stat-value">
                          {vault.targetAmount && vault.totalBalance ? Math.round((vault.totalBalance / vault.targetAmount) * 100) : 0}%
                        </div>
                    ...
                    <div className="vault-progress-section">
                      <div className="progress-bar">
                        <div 
                          ...
                          style={{ 
                            width: `${Math.min(100, vault.totalBalance && vault.targetAmount ? (vault.totalBalance / vault.targetAmount) * 100 : 0)}%` 
                          }}
                        ></div>
                      </div>
                      <div className="progress-text">
                        {vault.totalBalance || 0} / {vault.targetAmount} {vault.currency || 'USD'}
                      </div>
                    </div>
                  )}

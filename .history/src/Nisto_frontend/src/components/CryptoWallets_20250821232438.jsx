...
const CryptoWallets = () => {
  ...
  useEffect(() => {
    const loadWallets = async () => {
      ...
      try {
        ...
        const wallets = await backendService.getCryptoWallets();
  ...
  const handleCreateWallet = async () => {
    ...
    try {
      const result = await backendService.createCryptoWallet(newWallet.name, newWallet.currency);
      if (result.ok) {
        ...
        showToast(`Failed to create wallet: ${result.err}`, 'error');
      }
    } catch (error) {

...
const PayBills = () => {
  ...
  useEffect(() => {
    const loadBills = async () => {
      // Force using our mock data for now to ensure correct services
      console.log('Using mock data for bills');
      setAvailableBills([
          {
            id: 'mpesa-paybill',
            name: 'M-Pesa Paybill',

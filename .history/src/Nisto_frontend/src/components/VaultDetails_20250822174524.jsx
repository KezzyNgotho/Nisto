      ...
      <div style={{ display: 'flex', height: 'calc(100vh - 90px)' }}>
        ...
        <div style={{ flex: 1, padding: '2rem', overflow: 'auto' }}>
          ...
          {activeTab === 'transactions' && (
            <div style={{ background: 'white', borderRadius: 12, padding: '1.5rem', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <h3 style={{ margin: '0 0 1rem 0', color: theme.colors.text.primary }}>Transaction History</h3>
          ...
          {activeTab === 'governance' && (
            <div style={{ background: 'white', borderRadius: 12, padding: '1.5rem', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              <h3 style={{ margin: '0 0 1rem 0', color: theme.colors.text.primary }}>Governance</h3>
              <div style={{ textAlign: 'center', padding: '2rem', color: theme.colors.text.secondary }}>
        ...
        {showChat && (
          <div style={{ 
            ...
            borderLeft: `1px solid rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.1)`,
            display: 'flex',
            ...
            <div style={{ 
              padding: '1.25rem', 
              borderBottom: `1px solid rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.1)`,
              background: `linear-gradient(135deg, ${theme.colors.primary} 0%, ${theme.colors.primary}dd 100%)`,
              color: 'white',
              display: 'flex',
              alignItems: 'center',
              ...
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <button
                  ...
                  style={{
                    background: `rgba(${theme.colors.white.r}, ${theme.colors.white.g}, ${theme.colors.white.b}, 0.1)`,
                    border: 'none',
                    borderRadius: 6,
                    padding: '0.5rem',
                    cursor: 'pointer',
            ...
            <div style={{ 
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                <span style={{ fontSize: '0.8rem', color: theme.colors.text.secondary, fontWeight: 600 }}>Online:</span>
                {(details?.ok?.members || details?.members || []).slice(0, 3).map((member, index) => (
                  <div key={member.id} style={{ 
                    ...
                    <span style={{ fontSize: '0.75rem', color: theme.colors.text.primary }}>
            ...
            >
              ...
              {showScrollButton && (
                <button
                  ...
                  style={{
                    ...
                    bottom: '1rem',
                    right: '1rem',
                    background: unreadCount > 0 ? theme.colors.warning : theme.colors.primary,
                    color: 'white',
                    border: 'none',
                    borderRadius: '50%',
                    width: '40px',
              ...
              {unreadCount > 0 && !showScrollButton && (
                <div style={{
                  ...
                  background: `rgba(${theme.colors.warning.r}, ${theme.colors.warning.g}, ${theme.colors.warning.b}, 1)`,
                  color: 'white',
                  padding: '0.5rem 1rem',
                  borderRadius: '20px',
                  fontSize: '0.8rem',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                   ...
                   <div key={message.id || index} style={{ 
                    ...
                    <div style={{ 
                      ...
                      height: 36, 
                      borderRadius: '50%', 
                      background: (message.messageType === 'System' || message.type === 'system') ? `rgba(${theme.colors.border.primary.r}, ${theme.colors.border.primary.g}, ${theme.colors.border.primary.b}, 1)` : getUserAvatar(message.userId),
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      color: 'white',
                      ...
                      {(message.messageType !== 'System' && message.type !== 'system') && (
                        <div style={{ 
                          ...
                          <span style={{ 
                            fontSize: '0.75rem', 
                            fontWeight: 600, 
                            color: message.userId === user?.principal ? theme.colors.primary : theme.colors.text.secondary
                          }}>
                            {message.userName}
                          </span>
                          <span style={{ fontSize: '0.7rem', color: theme.colors.text.secondary }}>
                            {formatTime(message.timestamp)}
                          </span>
                        </div>
                      )}
                          <div style={{ 
                            background: (message.messageType === 'System' || message.type === 'system') ? theme.colors.background.secondary :
                           message.userId === user?.principal ? `rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 1)` : `rgba(${theme.colors.white.r}, ${theme.colors.white.g}, ${theme.colors.white.b}, 1)`,
                         color: (message.messageType === 'System' || message.type === 'system') ? theme.colors.text.secondary :
                                message.userId === user?.principal ? theme.colors.white : theme.colors.text.secondary,
                           ...
                           <div style={{ 
                             ...
                             {Object.entries(message.reactions).map(([reaction, count]) => (
                               <button
                                 ...
                                 style={{
                                   background: `rgba(${theme.colors.white.r}, ${theme.colors.white.g}, ${theme.colors.white.b}, 0.2)`,
                                   border: 'none',
                                   borderRadius: 12,
                                   padding: '0.25rem 0.5rem',
                                   fontSize: '0.75rem',
            ...
            <form onSubmit={handleSendMessage} style={{ 
              padding: '1.25rem', 
              borderTop: `1px solid rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.1)`,
              background: 'white',
              ...
              <div style={{ 
                ...
                <div style={{ flex: 1 }}>
                  <textarea
                    ...
                    style={{ 
                      ...
                      border: `1px solid rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.1)`, 
                      borderRadius: '12px',
                      fontSize: '0.9rem',
                      resize: 'none',
                      fontFamily: 'inherit',
                ...
                <button 
                  ...
                  style={{ 
                    background: newMessage.trim() ? `linear-gradient(135deg, ${theme.colors.primary} 0%, ${theme.colors.primary}dd 100%)` : `rgba(${theme.colors.white.r}, ${theme.colors.white.g}, ${theme.colors.white.b}, 0.1)`, 
                    color: 'white', 
                    border: 'none', 
                    borderRadius: '12px', 
                    padding: '0.875rem',
               ...
               <div style={{ 
                 ...
                 <button
                   ...
                   style={{
                     background: `rgba(${theme.colors.success.r}, ${theme.colors.success.g}, ${theme.colors.success.b}, 0.1)`,
                 ...
                 <button
                   ...
                   style={{
                     background: `rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.1)`,
                     color: theme.colors.primary,
                     border: `1px solid rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.2)`,
                     borderRadius: '10px',
                     padding: '0.75rem 0.5rem',
                     fontSize: '0.75rem',
                     cursor: 'pointer',
                   ...
                   onMouseEnter={(e) => {
                     e.target.style.background = `rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.15)`;
                     e.target.style.transform = 'translateY(-2px)';
                     e.target.style.boxShadow = `0 4px 12px rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.2)`;
                   }}
                   onMouseLeave={(e) => {
                     e.target.style.background = `rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.1)`;
                     e.target.style.transform = 'translateY(0)';
                     e.target.style.boxShadow = 'none';
                   }}
                 >
                 ...
                 <button
                   ...
                   onClick={() => setNewMessage(prev => prev + '🎯')}
                   style={{
                     background: `rgba(${theme.colors.warning.r}, ${theme.colors.warning.g}, ${theme.colors.warning.b}, 0.1)`,
                     color: theme.colors.warning,
                     border: `1px solid rgba(${theme.colors.warning.r}, ${theme.colors.warning.g}, ${theme.colors.warning.b}, 0.2)`,
                     borderRadius: '10px',
                     padding: '0.75rem 0.5rem',
                     fontSize: '0.75rem',
                     cursor: 'pointer',
                   ...
                   onMouseEnter={(e) => {
                     e.target.style.background = `rgba(${theme.colors.warning.r}, ${theme.colors.warning.g}, ${theme.colors.warning.b}, 0.15)`;
                     e.target.style.transform = 'translateY(-2px)';
                     e.target.style.boxShadow = `0 4px 12px rgba(${theme.colors.warning.r}, ${theme.colors.warning.g}, ${theme.colors.warning.b}, 0.2)`;
                   }}
                   onMouseLeave={(e) => {
                     e.target.style.background = `rgba(${theme.colors.warning.r}, ${theme.colors.warning.g}, ${theme.colors.warning.b}, 0.1)`;
                     e.target.style.transform = 'translateY(0)';
                     e.target.style.boxShadow = 'none';
                   }}
                 >
                 ...
                 <button
                   ...
                   onClick={() => setNewMessage(prev => prev + '📝')}
                   style={{
                     background: `rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 0.1)`,
                     color: theme.colors.text.secondary,
                     border: `1px solid rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 0.2)`,
                     borderRadius: '10px',
                     padding: '0.75rem 0.5rem',
                     fontSize: '0.75rem',
                     cursor: 'pointer',
                   ...
                   onMouseEnter={(e) => {
                     e.target.style.background = `rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 0.15)`;
                     e.target.style.transform = 'translateY(-2px)';
                     e.target.style.boxShadow = `0 4px 12px rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 0.2)`;
                   }}
                   onMouseLeave={(e) => {
                     e.target.style.background = `rgba(${theme.colors.text.secondary.r}, ${theme.colors.text.secondary.g}, ${theme.colors.text.secondary.b}, 0.1)`;
                     e.target.style.transform = 'translateY(0)';
                     e.target.style.boxShadow = 'none';
                   }}
                 >
                 ...
                 <button
                   ...
                   style={{
                     background: `rgba(${theme.colors.error.r}, ${theme.colors.error.g}, ${theme.colors.error.b}, 0.1)`,
                     color: theme.colors.error,
                     border: `1px solid rgba(${theme.colors.error.r}, ${theme.colors.error.g}, ${theme.colors.error.b}, 0.2)`,
                     borderRadius: '10px',
                     padding: '0.75rem 0.5rem',
                     fontSize: '0.75rem',
                     cursor: 'pointer',
                   ...
                   onMouseEnter={(e) => {
                     e.target.style.background = `rgba(${theme.colors.error.r}, ${theme.colors.error.g}, ${theme.colors.error.b}, 0.15)`;
                     e.target.style.transform = 'translateY(-2px)';
                     e.target.style.boxShadow = `0 4px 12px rgba(${theme.colors.error.r}, ${theme.colors.error.g}, ${theme.colors.error.b}, 0.2)`;
                   }}
                   onMouseLeave={(e) => {
                     e.target.style.background = `rgba(${theme.colors.error.r}, ${theme.colors.error.g}, ${theme.colors.error.b}, 0.1)`;
                     e.target.style.transform = 'translateY(0)';
                     e.target.style.boxShadow = 'none';
                   }}
                 >
        ...
        <div style={{
          ...
          <form onClick={e => e.stopPropagation()} onSubmit={handleDeposit} style={{
            ...
            <button type="button" onClick={() => setShowDeposit(false)} style={{
              ...
              top: 16,
              right: 16,
              background: `rgba(${theme.colors.black.r}, ${theme.colors.black.g}, ${theme.colors.black.b}, 0.1)`,
              border: 'none',
              borderRadius: '50%',
              width: 32,
              height: 32,
            ...
            <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
              ...
              <h2 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 700, color: theme.colors.success }}>Deposit to Vault</h2>
              <p style={{ margin: '0.5rem 0 0 0', color: theme.colors.text.secondary, fontSize: '0.9rem' }}>
            ...
            <div style={{ display: 'grid', gap: '1.5rem' }}>
              <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, color: theme.colors.text.secondary, fontSize: '0.9rem' }}>Amount *</label>
              ...
              <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, color: theme.colors.text.secondary, fontSize: '0.9rem' }}>Description (Optional)</label>
                <textarea 
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                  <span style={{ fontSize: '0.9rem', color: theme.colors.text.secondary }}>Current Balance:</span>
                  <span style={{ fontSize: '1.1rem', fontWeight: 700, color: theme.colors.success }}>
                    {vault?.totalBalance} {vault?.currency}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ fontSize: '0.9rem', color: theme.colors.text.secondary }}>New Balance:</span>
                  <span style={{ fontSize: '1.1rem', fontWeight: 700, color: theme.colors.success }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
              <button 
                ...
                onMouseEnter={(e) => e.target.style.borderColor = theme.colors.text.secondary}
                onMouseLeave={(e) => e.target.style.borderColor = theme.colors.border.primary}
              >
                Cancel
              </button>
              <button 
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: 12,
                  background: submitting || !depositAmount ? theme.colors.text.secondary : `linear-gradient(135deg, ${theme.colors.success}, ${theme.colors.success})`,
                  color: 'white',
                  fontSize: '1rem',
                  fontWeight: 600,
        ...
        <div style={{
          ...
          <form onClick={e => e.stopPropagation()} onSubmit={handleWithdraw} style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
              ...
              <h2 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 700, color: theme.colors.warning }}>Withdraw from Vault</h2>
              <p style={{ margin: '0.5rem 0 0 0', color: theme.colors.text.secondary, fontSize: '0.9rem' }}>
            ...
            <div style={{ display: 'grid', gap: '1.5rem' }}>
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input 
                    ...
                    onFocus={(e) => e.target.style.borderColor = theme.colors.warning}
                    onBlur={(e) => e.target.style.borderColor = theme.colors.border.primary}
                  />
                </div>
              </div>
              ...
              <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, color: theme.colors.text.secondary, fontSize: '0.9rem' }}>Reason (Optional)</label>
                <textarea 
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                  <span style={{ fontSize: '0.9rem', color: theme.colors.text.secondary }}>Current Balance:</span>
                  <span style={{ fontSize: '1.1rem', fontWeight: 700, color: theme.colors.warning }}>
                    {vault?.totalBalance} {vault?.currency}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span style={{ fontSize: '0.9rem', color: theme.colors.text.secondary }}>Remaining Balance:</span>
                  <span style={{ fontSize: '1.1rem', fontWeight: 700, color: theme.colors.warning }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
              ...
              <button 
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: 12,
                  background: submitting || !withdrawAmount || parseFloat(withdrawAmount) > parseFloat(vault?.totalBalance || 0) ? theme.colors.text.secondary : `linear-gradient(135deg, ${theme.colors.warning}, ${theme.colors.warning})`,
                  color: 'white',
                  fontSize: '1rem',
                  fontWeight: 600,
        ...
        <div style={{
          ...
          <form onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
              ...
              <h2 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 700, color: theme.colors.primary }}>Invite Member</h2>
              <p style={{ margin: '0.5rem 0 0 0', color: theme.colors.text.secondary, fontSize: '0.9rem' }}>
            ...
            <div style={{ display: 'grid', gap: '1.5rem' }}>
              <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, color: theme.colors.text.secondary, fontSize: '0.9rem' }}>User ID *</label>
                <input 
                  type="text" 
              ...
              <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 600, color: theme.colors.text.secondary, fontSize: '0.9rem' }}>Role *</label>
                <select 
                  value={inviteRole} 
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                  <FiUsers size={16} color={theme.colors.primary} />
                  <span style={{ fontSize: '0.9rem', fontWeight: 600, color: theme.colors.primary }}>Current Members</span>
                </div>
                <div style={{ fontSize: '1.1rem', fontWeight: 700, color: theme.colors.primary }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
              ...
              <button 
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: 12,
                  background: submitting || !inviteUserId ? theme.colors.text.secondary : `linear-gradient(135deg, ${theme.colors.primary}, ${theme.colors.primary})`,
                  color: 'white',
                  fontSize: '1rem',
                  fontWeight: 600,
                  cursor: submitting || !inviteUserId ? 'not-allowed' : 'pointer',
                  transition: 'all 0.2s',
                  boxShadow: submitting || !inviteUserId ? 'none' : `0 4px 12px rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.3)`
                }}

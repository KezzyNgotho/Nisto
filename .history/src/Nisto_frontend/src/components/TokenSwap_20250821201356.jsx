...
const TokenSwap = () => {
  ...
  return (
    <div className="token-form">
      ...
      {/* Settings Modal */}
      {showSettings && (
        <div className="token-form" style={{ marginBottom: '1rem', padding: '1rem', backgroundColor: '#f9fafb', borderRadius: '0.5rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', margin: '1rem 0' }}>
        <button
          ...
          style={{ padding: '0.5rem', borderRadius: '50%', width: '2.5rem', height: '2.5rem' }}
        >
          <FiArrowRight />
        </button>
      </div>

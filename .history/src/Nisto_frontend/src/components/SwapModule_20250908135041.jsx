          ...
          {swapHistory.length > 0 && (
            <div className="swap-history-card" style={{ 
              ...
              <div className="card-header">
                ...
                <span style={{ color: theme.colors.text.secondary, fontSize: '0.8rem' }}>{swapHistory.length} transactions</span>
              </div>
                  ...
                  >
                    <div className="swap-info">
                      <div className="swap-amounts">
                        <span style={{ color: theme.colors.text.primary, fontSize: '0.9rem', fontWeight: '600' }}>{swap.from}</span>
                        <FiRotateCcw style={{ color: theme.colors.text.secondary, fontSize: '0.8rem' }} />
                        <span style={{ color: theme.colors.text.primary, fontSize: '0.9rem', fontWeight: '600' }}>{swap.to}</span>
                      </div>
                      <div className="swap-details">
                        <span style={{ color: theme.colors.text.secondary, fontSize: '0.75rem' }}>
                          {new Date(swap.timestamp).toLocaleString()}
                        </span>
                      </div>
                    </div>
                    <div className="swap-status">
                      <FiCheck style={{ color: theme.colors.success || '#10b981', fontSize: '0.8rem' }} />
                      <span style={{ color: theme.colors.success || '#10b981', fontSize: '0.8rem' }}>Completed</span>
                    </div>
                  </div>
                ))}
              </div>

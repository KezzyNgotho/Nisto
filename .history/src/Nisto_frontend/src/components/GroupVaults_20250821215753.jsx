                ...
                >
                  ...
                  <div style={{ 
                    ...
                    <div style={{ textAlign: 'center', flex: 1 }}>
                      <div style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '0.5rem', fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Balance</div>
                      <div style={{ fontSize: '1.25rem', color: '#10b981', fontWeight: 800, letterSpacing: '-0.025em' }}>{vault.totalBalance}</div>
                    </div>
                    <div style={{ width: '1px', height: '2.5rem', background: 'linear-gradient(to bottom, transparent, #cbd5e1, transparent)' }} />
                    <div style={{ textAlign: 'center', flex: 1 }}>
                      <div style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '0.5rem', fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Currency</div>
                      <div style={{ fontSize: '1.25rem', color: '#3b82f6', fontWeight: 800, letterSpacing: '-0.025em' }}>{vault.currency}</div>
                    </div>
                    <div style={{ width: '1px', height: '2.5rem', background: 'linear-gradient(to bottom, transparent, #cbd5e1, transparent)' }} />
                    <div style={{ textAlign: 'center', flex: 1 }}>
                      <div style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '0.5rem', fontWeight: 700, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Members</div>
                      <div style={{ fontSize: '1.25rem', color: '#8b5cf6', fontWeight: 800, letterSpacing: '-0.025em' }}>{vault.members ? vault.members.length : '—'}</div>
                    </div>
                  </div>

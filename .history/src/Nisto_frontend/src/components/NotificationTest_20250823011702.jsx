...
export default function NotificationTest() {
  ...
  const loadNotifications = async () => {
    setIsLoading(true);
    try {
      const result = await SimpleNotificationService.getNotifications(10, 0);
      ...
      console.log(`Loaded ${result?.length || 0} notifications`);
    } catch (error) {
  ...
  const createTestNotification = async (notificationData) => {
    try {
      const result = await SimpleNotificationService.createTestNotification(

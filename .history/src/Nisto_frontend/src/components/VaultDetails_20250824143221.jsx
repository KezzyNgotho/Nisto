...
export default function VaultDetails({
  ...
  const isAdmin = details?.members?.some(
    (m) => m.userId === user?.principal && m.role === "admin"
  );
        ...
        try {
          ...
          if (result.ok) {
            const typingUserIds = result.ok
              .filter(
                (indicator) =>
                  indicator.isTyping && indicator.userId !== user?.principal
              )
      ...
      if (isNearBottom && unreadCount > 0) {
        ...
        if (chatMessages.length > 0) {
          ...
          if (vault?.id) {
            ...
            backendService
              .markMessagesAsRead(vault.id, messageIds)
              .catch((error) => {
  ...
  const handleInviteMember = async (e) => {
    ...
    setError(null);
    try {
      const result = await inviteVaultMember(
        vault.id,
        inviteUserId,
        inviteRole
      );
      if (result.ok) {
        ...
        showToast({
          message: "Invitation sent successfully! The user will receive a notification and must accept to join the vault.",
          type: "success",
          icon: <FiCheck />,
        });
        onBack();
      } else {
        setError(result.err || "Failed to send invitation");
      }
    } catch (err) {
      setError("Failed to send invitation");
      showToast({ message: "Invitation failed", type: "error", icon: <FiX /> });
    } finally {
      setSubmitting(false);
    }
  };
    ...
    >
      ...
      <div style={{ display: "flex", height: "calc(100vh - 90px)" }}>
        ...
        <div style={{ flex: 1, padding: "2rem", overflow: "auto" }}>
          ...
          >
            {["overview", "members", "transactions", "governance"].map(
              (tab) => (
                <button
                  key={tab}
                ...
                >
                  {tab === "overview" && (
                    <FiEye size={16} style={{ marginRight: "0.5rem" }} />
                  )}
                  {tab === "members" && (
                    <FiUsers size={16} style={{ marginRight: "0.5rem" }} />
                  )}
                  {tab === "transactions" && (
                    <FiList size={16} style={{ marginRight: "0.5rem" }} />
                  )}
                  {tab === "governance" && (
                    ...
                    {vault?.targetAmount && (
                      <div style={{ marginTop: "0.5rem" }}>
                        ...
                        >
                          ...
                          <span>
                            {Math.round(
                              (vault?.totalBalance / vault?.targetAmount) * 100
                            )}
                            %
                          </span>
                        </div>
                        ...
                        >
                          <div
                            ...
                            style={{
                              width: `${Math.min(
                                (vault?.totalBalance / vault?.targetAmount) *
                                  100,
                                100
                              )}%`,
                              height: "100%",
                  ...
                  <div className="vault-stat">
                    ...
                    >
                      ...
                      {vault?.isPublic ? (
                        ...
                        <FiLock size={16} color={theme.colors.warning} />
                      )}
                    </div>
                    <div
                      style={{
              ...
              <div className="vault-card" style={{ padding: "2rem" }}>
                ...
                <div style={{ display: "grid", gap: "1rem" }}>
                  ...
                  >
                    ...
                    >
                      <SafeIcon iconName="FiUserPlus" size={16} />
                    </div>
          ...
          {activeTab === "members" && (
            <div className="vault-card" style={{ padding: "2rem" }}>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      {(details?.ok?.members || details?.members || []).length}{" "}
                      active members
                    </p>
                  </div>
                </div>
              ...
              <div style={{ display: "grid", gap: "1rem" }}>
                {(details?.ok?.members || details?.members || []).map(
                  (member) => (
                      ...
                      >
                        ...
                        >
                          <div
                            style={{
                              ...
                              background:
                                member.role === "owner"
                                  ? `linear-gradient(135deg, ${theme.colors.warning} 0%, ${theme.colors.warning}dd 100%)`
                                  : member.role === "admin"
                        ...
                        <div style={{ display: "flex", gap: "0.5rem" }}>
                          <button
                            ...
                            onMouseEnter={(e) =>
                              (e.target.style.background = `rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.2)`)
                            }
                            onMouseLeave={(e) =>
                          ...
                          {(isOwner || isAdmin) && member.role !== "owner" && (
                            <button
                              ...
                              onMouseEnter={(e) =>
                                (e.target.style.background = `rgba(${theme.colors.error.r}, ${theme.colors.error.g}, ${theme.colors.error.b}, 0.2)`)
                              }
                              onMouseLeave={(e) =>
            ...
            >
              ...
              >
                ...
                <p style={{ fontSize: "0.9rem" }}>
                  Transactions will appear here when members deposit or withdraw
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === "governance" && (
            ...
            >
              ...
              >
                ...
                <p style={{ fontSize: "0.9rem" }}>
                  Proposals will appear here when members suggest changes
                </p>
              </div>
            </div>
          )}
          ...
          >
                ...
                <div>
                  ...
                  >
                    {details?.ok?.members?.length ||
                      details?.members?.length ||
                      0}{" "}
                    members • {chatMessages.length} messages
                  </p>
                </div>
              </div>
              <div style={{ display: "flex", gap: "0.5rem" }}>
            ...
            >
              ...
              >
                ...
                {(details?.ok?.members || details?.members || [])
                  .slice(0, 3)
                  .map((member, index) => (
                    <div
                      key={member.id}
              ...
              {showScrollButton && (
                <button
                  ...
                  style={{
                    ...
                    justifyContent: "center",
                    cursor: "pointer",
                    boxShadow: `0 2px 8px rgba(${theme.colors.black.r}, ${theme.colors.black.g}, ${theme.colors.black.b}, 0.2)`,
                    zIndex: 10,
                    transition: "all 0.2s",
                    position: "relative",
                  }}
                    ...
                    <div
                      style={{
                        ...
                        background:
                          message.messageType === "System" ||
                          message.type === "system"
                            ? `rgba(${theme.colors.border.primary.r}, ${theme.colors.border.primary.g}, ${theme.colors.border.primary.b}, 1)`
                        ...
                        style={{
                          background:
                            ...
                            message.type === "system"
                              ...
                              : message.userId === user?.principal
                              ? `rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 1)`
                              : `rgba(${theme.colors.white.r}, ${theme.colors.white.g}, ${theme.colors.white.b}, 1)`,
                          color:
                            message.messageType === "System" ||
                            message.type === "system"
                              ? theme.colors.text.secondary
                          ...
                          border:
                            ...
                            message.type !== "system" &&
                            message.userId !== user?.principal
                              ? `1px solid rgba(${theme.colors.border.primary.r}, ${theme.colors.border.primary.g}, ${theme.colors.border.primary.b}, 1)`
                              : "none",
                          boxShadow:
                            message.messageType !== "System" &&
                            message.type !== "system"
                              ? `0 1px 3px rgba(${theme.colors.black.r}, ${theme.colors.black.g}, ${theme.colors.black.b}, 0.1)`
                              : "none",
                          position: "relative",
                        }}
                      >
                              ...
                              {Object.entries(message.reactions).map(
                                ([reaction, count]) => (
                                  <button
                                    ...
                                    style={{
                                      background: `rgba(${theme.colors.border.primary.r}, ${theme.colors.border.primary.g}, ${theme.colors.border.primary.b}, 0.2)`,
                                      border: "none",
                                      borderRadius: 12,
                                      padding: "0.25rem 0.5rem",
                                      fontSize: "0.75rem",
                        ...
                        {message.type !== "system" && (
                          <button
                            ...
                            style={{
                              ...
                              top: "0.25rem",
                              right: "0.25rem",
                              background: `rgba(${theme.colors.border.primary.r}, ${theme.colors.border.primary.g}, ${theme.colors.border.primary.b}, 0.1)`,
                              border: "none",
                              borderRadius: 4,
                              padding: "0.25rem",
                              cursor: "pointer",
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        borderRadius: 12,
                        border: `1px solid ${theme.colors.border.primary}`,
                        boxShadow: `0 1px 3px rgba(${theme.colors.black.r}, ${theme.colors.black.g}, ${theme.colors.black.b}, 0.1)`,
                      }}
                    >
            ...
            <form
              ...
              style={{
                ...
                background: "white",
                boxShadow: `0 -2px 8px rgba(${theme.colors.black.r}, ${theme.colors.black.g}, ${theme.colors.black.b}, 0.05)`,
              }}
            >
              <div
                style={{
                ...
                <div style={{ flex: 1 }}>
                  <textarea
                    ...
                    style={{
                      ...
                      fontFamily: "inherit",
                      outline: "none",
                      background: `linear-gradient(135deg, ${theme.colors.border.primary} 0%, ${theme.colors.border.primary} 100%)`,
                      transition: "all 0.3s ease",
                    }}
                    onKeyDown={(e) => {
                ...
                <button
                  ...
                  style={{
                    background: newMessage.trim()
                      ? `linear-gradient(135deg, ${theme.colors.primary} 0%, ${theme.colors.primary}dd 100%)`
                      : `rgba(${theme.colors.white.r}, ${theme.colors.white.g}, ${theme.colors.white.b}, 0.1)`,
                    color: "white",
                    border: "none",
                    borderRadius: "12px",
                    padding: "0.875rem",
              ...
              >
                ...
                >
                  ...
                  >
                    {depositAmount
                      ? (
                          parseFloat(vault?.totalBalance || 0) +
                          parseFloat(depositAmount)
                        ).toFixed(2)
                      : vault?.totalBalance}{" "}
                    {vault?.currency}
            ...
            <div style={{ display: "flex", gap: "1rem", marginTop: "2rem" }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 12,
                  background:
                    submitting || !depositAmount
                      ? theme.colors.text.secondary
                      : `linear-gradient(135deg, ${theme.colors.success}, ${theme.colors.success})`,
                  color: "white",
                  fontSize: "1rem",
                  fontWeight: 600,
                  cursor:
                    submitting || !depositAmount ? "not-allowed" : "pointer",
                  transition: "all 0.2s",
                  boxShadow:
                    submitting || !depositAmount
                      ? "none"
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    onFocus={(e) =>
                      (e.target.style.borderColor = theme.colors.warning)
                    }
                    onBlur={(e) =>
                      (e.target.style.borderColor = theme.colors.border.primary)
                    }
                ...
                style={{
                  ...
                  background:
                    ...
                    parseFloat(withdrawAmount) >
                      parseFloat(vault?.totalBalance || 0)
                      ? theme.colors.text.secondary
                      : `linear-gradient(135deg, ${theme.colors.warning}, ${theme.colors.warning})`,
                  color: "white",
                  fontSize: "1rem",
                  fontWeight: 600,
                  cursor:
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "center", marginBottom: "2rem" }}>
              ...
              >
                <SafeIcon iconName="FiUserPlus" size={24} color="white" />
              </div>
              <h2
                style={{
                  margin: 0,
            ...
            <div style={{ display: "grid", gap: "1.5rem" }}>
              ...
              <div>
                ...
                >
                  <option value="member">
                    👤 Member - Can deposit, withdraw, and view vault
                  </option>
                  <option value="admin">
                    🛡️ Admin - Can manage vault settings and members
                  </option>
                </select>
              </div>
            ...
            <div style={{ display: "flex", gap: "1rem", marginTop: "2rem" }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 12,
                  background:
                    submitting || !inviteUserId
                      ? theme.colors.text.secondary
                      : `linear-gradient(135deg, ${theme.colors.primary}, ${theme.colors.primary})`,
                  color: "white",
                  fontSize: "1rem",
                  fontWeight: 600,
                  cursor:
                    submitting || !inviteUserId ? "not-allowed" : "pointer",
                  transition: "all 0.2s",
                  boxShadow:
                    submitting || !inviteUserId
                      ? "none"
                      : `0 4px 12px rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 0.3)`,
                }}
                onMouseEnter={(e) =>
                  !submitting &&
                  inviteUserId &&

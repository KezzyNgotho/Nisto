                ...
                {displayedCoins.map((coin) => (
                  <div key={coin.id} className="table-row">
                    <div className="table-cell rank">
                      {coin.rank || coin.market_cap_rank || 'N/A'}
                    </div>
                    <div className="table-cell name">
                      <div className="coin-info">
                        <div className="coin-avatar">
                          ...
                          <div className="coin-fallback" style={{ display: coin.image ? 'none' : 'flex' }}>
                    ...
                    <div className="table-cell price text-right">
                      {formatPrice(coin.current_price || coin.price || 0, quoteCurrency)}
                    </div>
                    <div className="table-cell change text-right">
                      <div className={`change-value ${
                        (coin.change24h || coin.price_change_percentage_24h || 0) >= 0 ? 'positive' : 'negative'
                      }`}>
                        {(coin.change24h || coin.price_change_percentage_24h || 0) >= 0 ? (
                    ...
                    <div className="table-cell volume text-right">
                      {formatVolume(coin.volume || coin.total_volume || 0)}
                    </div>
                    <div className="table-cell market-cap text-right">
                      {formatMarketCap(coin.marketCap || coin.market_cap || 0)}
                    </div>
                  </div>
                ))}
              </div>

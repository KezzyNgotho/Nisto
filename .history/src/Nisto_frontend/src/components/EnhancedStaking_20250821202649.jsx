  ...
  return (
    <div className="token-form">
        ...
        <div style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '0.75rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: '#6b7280' }}>Staked</span>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <span style={{ color: stakingData.isStaking ? '#10b981' : '#6b7280' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
        ...
        <div>
          <div style={{ height: '2.5rem', display: 'flex', alignItems: 'center', color: '#6b7280', fontSize: '0.875rem' }}>
            Available to claim
          </div>
          <button
          ...
          >
            <FiActivity />
            <span>Claim ({stakingData.pendingRewards.toFixed(6)} NST)</span>
          </button>
        </div>
      </div>

      {/* Row 5: Auto Compound and Statistics */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
      ...
      <div>
        <div style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '0.75rem', fontSize: '0.75rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>

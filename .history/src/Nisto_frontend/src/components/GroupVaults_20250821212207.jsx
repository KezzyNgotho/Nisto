                ...
                >
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: '0.875rem', color: '#64748b', marginBottom: '0.75rem', lineHeight: '1.4' }}>
                        {vault.description}
                      </div>
                    </div>
                    <span style={{ 
                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '0.25rem' }}>Monthly Goal</div>
                        <div style={{ fontSize: '1.125rem', fontWeight: '600', color: '#10b981' }}>
                          ${vault.monthlyGoal.toLocaleString()}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '1rem' }}>
                    <div style={{ 
                      ...
                      <div style={{ fontSize: '0.75rem', color: '#166534', marginBottom: '0.25rem', fontWeight: '500' }}>Members</div>
                      <div style={{ fontSize: '1rem', fontWeight: '700', color: '#166534' }}>
                        {vault.members.length}/{vault.maxMembers}
                      </div>
                    </div>
                    <div style={{ 
                      ...
                      <div style={{ fontSize: '0.75rem', color: '#0369a1', marginBottom: '0.25rem', fontWeight: '500' }}>Avg Contribution</div>
                    ...
                    <div style={{ 
                      ...
                      <div style={{ fontSize: '0.75rem', color: '#92400e', marginBottom: '0.25rem', fontWeight: '500' }}>Created</div>
                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.75rem', color: '#64748b' }}>
                      ...
                      <span>{vault.isPublic ? 'Public' : 'Private'}</span>
                    </div>
                  </div>
                </div>
              );

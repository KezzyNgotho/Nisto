...
export default function AIFinancialAssistant() {
  ...
  return (
    <div className="ai-assistant-component" style={{
      width: '100%',
      height: '100vh',
      ...
      <div className="ai-assistant-header" style={{
        ...
        <div className="ai-assistant-icon" style={{
          width: 48,
          height: 48,
          background: 'linear-gradient(135deg, #075B5E 0%, #1C352D 100%)',
          borderRadius: '12px',
        ...
        <div className="ai-assistant-title">
          <h2 className="ai-assistant-title-text" style={{ margin: 0, fontSize: '1.5rem', fontWeight: 700, color: '#1a202c' }}>
            AI Financial Assistant
          </h2>
          <p className="ai-assistant-subtitle" style={{ margin: '0.25rem 0 0 0', color: '#718096', fontSize: '0.9rem' }}>
            Your personal financial advisor powered by AI
          </p>
        </div>
        <div className="ai-assistant-actions" style={{ marginLeft: 'auto', display: 'flex', gap: '0.5rem' }}>
          <button style={{
      ...
      {/* Quick Actions */}
      <div className="ai-assistant-quick-actions" style={{
        background: 'rgba(255, 255, 255, 0.9)',
        padding: '1rem 2rem',
        borderBottom: '1px solid rgba(255, 255, 255, 0.2)'
      }}>
        <p className="ai-assistant-quick-title" style={{ margin: '0 0 1rem 0', fontSize: '0.9rem', color: '#718096', fontWeight: 600 }}>
          Quick Actions
        </p>
        <div className="ai-assistant-quick-grid dashboard-grid" style={{
          display: 'grid',
          ...
          {quickActions.map((action, index) => (
            <button
              key={index}
              className="ai-assistant-quick-btn dashboard-btn"

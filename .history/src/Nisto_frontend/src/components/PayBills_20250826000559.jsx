...
const PayBills = () => {
  ...
  const [packageType, setPackageType] = useState(''); // Added missing state variable
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  if (selectedBill?.id !== bill.id) {
                    ...
                    e.currentTarget.style.boxShadow = `0 8px 25px ${bill.color}20`;
                    e.currentTarget.style.borderColor = bill.color;
                  }
                }}
                onMouseLeave={(e) => {
                  if (selectedBill?.id !== bill.id) {
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <div style={{
                    width: '32px',
                    height: '32px',
                    background: 'linear-gradient(135deg, '#3b82f6' 0%, '#2563' 100%)',
                    borderRadius: '50%',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',

  ...
  const handleStartRecovery = async (e) => {
    ...
    try {
      ...
      switch (selectedMethod.value) {
        case 'email':
          result = await initiateRecovery(identifier, 'email');
          break;
          
        case 'phone':
          result = await initiateRecovery(identifier, 'phone');
          break;
          
        case 'security':
          result = await initiateRecovery(JSON.stringify(securityAnswers), 'security');
          break;
          
        case 'authenticator':
          result = await initiateRecovery('authenticator', 'authenticator');
          break;

        ...
        <div style={{
          ...
          <form onSubmit={handleCreate} style={{
            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div>
                <label style={{ display: 'block', marginBottom: '0.375rem', fontWeight: 600, color: '#374151', fontSize: '0.75rem' }}>Description</label>
                <textarea 
              ...
              <div style={{
                ...
                />
                <div>
                  <div style={{ fontWeight: 600, color: '#0369a1', fontSize: '0.8rem' }}>Public Vault</div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1.5rem' }}>
              ...
              <button 
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: '0.5rem',
                  background: submitting ? '#9ca3af' : `rgba(${theme.colors.primary.r}, ${theme.colors.primary.g}, ${theme.colors.primary.b}, 1)`,
                  color: 'white',
                  fontSize: '0.875rem',
                  fontWeight: 600,

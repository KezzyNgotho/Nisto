...
function Overview() {
  ...
  return (
    <div className="overview-container">
      ...
      {/* Portfolio Summary Row - Prominent with Assets */}
        ...
        <div className="portfolio-summary-card">
          ...
          <div className="portfolio-stats">
            <div className="portfolio-stat-item">
              ...
              <span className="portfolio-stat-value">{mockAssets.length}</span>
            </div>
            <div className="portfolio-stat-item">
              <span className="portfolio-stat-label">Largest Holding</span>
              <span className="portfolio-stat-value">Bitcoin (45%)</span>
            </div>
            <div className="portfolio-stat-item">
              <span className="portfolio-stat-label">Best Performer</span>
              <span className="portfolio-stat-value positive">Solana (+8.3%)</span>
            </div>
          </div>
          ...
          <div className="portfolio-assets">
            <div className="portfolio-assets-header">
              <h4 className="portfolio-assets-title">Your Assets</h4>
              <div className="portfolio-assets-actions">
                <button className="portfolio-asset-btn">
                  <FiPlus />
                  Add Asset
                </button>
                <button className="portfolio-asset-btn">
              ...
              {mockAssets.map((asset, index) => (
                ...
                >
                  <div className="portfolio-asset-info">
                    <div className="portfolio-asset-icon" style={{ backgroundColor: asset.color }}>
                      {asset.icon}
                    </div>
                  ...
                  <div className="portfolio-asset-values">
                    ...
                    <div className="portfolio-asset-percentage">
                      {asset.percentage}%
                    </div>
                  </div>
                  
                  <div className="portfolio-asset-change">
                    <div className={`portfolio-change-badge ${asset.priceChange >= 0 ? 'positive' : 'negative'}`}>
                      {asset.priceChange >= 0 ? '+' : ''}{asset.priceChange}%
                    </div>
                    <div className="portfolio-asset-price">
                      {asset.symbol === 'USDC' ? '$1.00' : `$${asset.price.toLocaleString()}`}
                    </div>
                  </div>
                  
                  <div className="portfolio-asset-actions">
                    <button className="portfolio-quick-btn">Send</button>
                    <button className="portfolio-quick-btn">Receive</button>
                  </div>
                </div>
              ))}
            </div>

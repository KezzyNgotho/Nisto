...
const SwapInterface = ({ onSwapComplete }) => {
  ...
  return (
    <div className="swap-interface">
      {/* Header */}
      <div className="swap-interface-header">
        <div className="header-content">
          <div className="title-section">
            <ArrowRightLeft className="title-icon" />
            <h2 className="interface-title">Token Swap</h2>
          </div>
          <Badge variant="secondary" className="routing-badge">
        ...
        <Alert>
          ...
          <AlertDescription>
            <div className="space-y-2">
              ...
              <Progress value={swapStatus.progress} className="h-2" />
            </div>
          </AlertDescription>
        </Alert>
      )}

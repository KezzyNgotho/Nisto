    ...
    <div className="token-form" style={{ maxWidth: '100%' }}>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <div style={{ 
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            <span style={{ fontWeight: '600', fontSize: '1rem' }}>Current APY</span>
            <span style={{ color: '#10b981', fontWeight: '600', fontSize: '1.25rem' }}>{APY}%</span>
          </div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
          ...
          <div>
            <div style={{ height: '2.5rem', display: 'flex', alignItems: 'center', color: '#6b7280', fontSize: '0.875rem', marginBottom: '0.5rem' }}>
              Available to claim
            </div>
            <button
      ...
      <div style={{ marginBottom: '2rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
          ...
          <div style={{ 
            ...
            <div>
              <div style={{ fontWeight: '600', fontSize: '1rem' }}>Auto Compound</div>
              <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Automatically reinvest rewards</div>
            </div>
            <button

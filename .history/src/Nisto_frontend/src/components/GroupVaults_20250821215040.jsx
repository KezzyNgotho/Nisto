                ...
                >
                  ...
                  <div style={{ 
                    ...
                    <div style={{ textAlign: 'center', flex: 1 }}>
                      ...
                      <div style={{ fontSize: '1.125rem', color: '#10b981', fontWeight: 700 }}>{vault.totalBalance}</div>
                    </div>
                    ...
                    <div style={{ textAlign: 'center', flex: 1 }}>
                      ...
                      <div style={{ fontSize: '1.125rem', color: '#3b82f6', fontWeight: 700 }}>{vault.currency}</div>
                    </div>
                    <div style={{ width: '1px', height: '2rem', background: '#e2e8f0' }} />
                    <div style={{ textAlign: 'center', flex: 1 }}>
                      <div style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '0.25rem', fontWeight: 600 }}>Members</div>
                      <div style={{ fontSize: '1.125rem', color: '#8b5cf6', fontWeight: 700 }}>{vault.members ? vault.members.length : '—'}</div>
                    </div>
                  </div>

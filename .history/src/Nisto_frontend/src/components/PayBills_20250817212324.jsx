...
const PayBills = ({ auth, backendService }) => {
  ...
  const handlePayment = async () => {
    ...
    if (selectedBill.id === 'send-money' && (!phoneNumber || !recipientPhone || !recipientName)) {
      setError('Please fill in your phone number, recipient phone and name');
      return;
    }
    ...
    <div className="paybills-container">
      ...
      <div className="payment-form">
        ...
        <div className="form-section">
             ...
             disabled={loading || !selectedBill || !selectedWallet || !kesAmount || (selectedBill?.id === 'send-money' && !phoneNumber)}
           >
            {loading ? (
              <>

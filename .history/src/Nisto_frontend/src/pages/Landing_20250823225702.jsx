        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <div className="hero-mockups">
              ...
              <div className="desktop-mockup" style={{ marginBottom: '32px' }}>
              ...
              {/* Mobile App Mockup */}
              <div className="mobile-mockup" style={{ display: 'flex', justifyContent: 'center' }}>
                  ...
                  <div className="phone-screen" style={{ 
                    ...
                    <div className="app-header" style={{ 
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <div style={{ 
                          ...
                          <span style={{ color: theme.colors.primary, fontSize: '12px', fontWeight: '600' }}>N</span>
                        </div>
                        <span style={{ color: theme.colors.white, fontSize: '16px', fontWeight: '600' }}>Nisto</span>
                      </div>
                    ...
                    <div className="app-content" style={{ padding: '16px' }}>
                      ...
                      <div style={{ 
                        ...
                        <div style={{ color: theme.colors.text.secondary, fontSize: '12px', marginBottom: '4px' }}>Total Balance</div>
                        <div style={{ color: theme.colors.text.primary, fontSize: '24px', fontWeight: '700', marginBottom: '8px' }}>KES 125,890</div>
                        <div style={{ color: theme.colors.success, fontSize: '14px', fontWeight: '600' }}>+12.5% today</div>
                      </div>
                      ...
                      {/* Recent Transactions */}
                      <div>
                        <div style={{ color: theme.colors.text.primary, fontSize: '14px', fontWeight: '600', marginBottom: '12px' }}>Recent Activity</div>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '8px', backgroundColor: theme.colors.background?.secondary || theme.colors.background, borderRadius: '8px' }}>
                            <div style={{ 
                              width: '32px', 
                              height: '32px', 
                            ...
                            <div style={{ flex: 1 }}>
                              <div style={{ color: theme.colors.text.primary, fontSize: '12px', fontWeight: '500' }}>Received BTC</div>
                              <div style={{ color: theme.colors.text.secondary, fontSize: '10px' }}>2 minutes ago</div>
                            </div>
                            <div style={{ color: theme.colors.success, fontSize: '12px', fontWeight: '600' }}>+₿0.001</div>
                          </div>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '8px', backgroundColor: theme.colors.background?.secondary || theme.colors.background, borderRadius: '8px' }}>
                            ...
                            <div style={{ flex: 1 }}>
                              <div style={{ color: theme.colors.text.primary, fontSize: '12px', fontWeight: '500' }}>Sent ETH</div>
                              <div style={{ color: theme.colors.text.secondary, fontSize: '10px' }}>1 hour ago</div>
                            </div>
                            <div style={{ color: theme.colors.error, fontSize: '12px', fontWeight: '600' }}>-Ξ0.05</div>
                          </div>
                        </div>
                      </div>
                    </div>

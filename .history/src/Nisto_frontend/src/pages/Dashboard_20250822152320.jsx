              ...
              <div style={{
                ...
                >
                  <div style={{
                    width: '40px',
                    height: '40px',
                    background: `linear-gradient(135deg, ${theme.colors.success} 0%, ${theme.colors.success} 100%)`,
                    borderRadius: '50%',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                  ...
                  <span style={{ fontWeight: 600, color: theme.colors.text.primary, fontSize: '0.875rem' }}>Send</span>
                </button>
                ...
                >
                  ...
                  <span style={{ fontWeight: 600, color: theme.colors.text.primary, fontSize: '0.875rem' }}>Receive</span>
                </button>
                ...
                >
                  ...
                  <span style={{ fontWeight: 600, color: theme.colors.text.primary, fontSize: '0.875rem' }}>Add Wallet</span>
                </button>
                ...
                >
                  <div style={{
                    width: '40px',
                    height: '40px',
                    background: `linear-gradient(135deg, ${theme.colors.info} 0%, ${theme.colors.info} 100%)`,
                    borderRadius: '50%',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                  ...
                  <span style={{ fontWeight: 600, color: theme.colors.text.primary, fontSize: '0.875rem' }}>Tokens</span>
                </button>
              ...
              <div style={{
               ...
               <div style={{
                 ...
                 <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                   ...
                   <div>
                     <h4 style={{ margin: '0 0 0.25rem 0', fontSize: '1rem', fontWeight: '600', color: theme.colors.text.primary }}>
                       Account Security
                     </h4>

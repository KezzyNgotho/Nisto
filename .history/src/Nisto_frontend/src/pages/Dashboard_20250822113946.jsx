      ...
      >
        ...
        <nav style={{ flex: 1, textAlign: 'left' }}>
          <div style={{ marginBottom: '1rem' }}>
            {!sidebarCollapsed && (
              <h3 style={{ fontSize: '0.75rem', fontWeight: 600, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.75rem', textAlign: 'left' }}>
                Wallet
              </h3>
            )}
            ...
            <div style={{ width: '100%', padding: '1.5rem' }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                  ...
                  <div>
                    <h4 style={{ margin: '0 0 0.25rem 0', fontSize: '1rem', fontWeight: '600', color: '#92400e' }}>
                      Recovery Security
                    </h4>
                    <p style={{ margin: 0, fontSize: '0.875rem', color: '#92400e' }}>
                      Set up multiple recovery methods to ensure you never lose access to your account
                    </p>
                  </div>
                </div>
      ...
      {showRecoveryModal && (
        <EnhancedAccountRecovery
          ...
          onRecoveryComplete={() => {
            ...
            showToast({ message: 'Recovery method added successfully!', type: 'success' });
          }}
          mode="setup"
        />
      )}

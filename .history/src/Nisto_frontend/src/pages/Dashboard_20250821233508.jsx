            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              ...
              <button
                ...
                style={{
                  ...
                  gap: '0.75rem',
                  padding: '0.75rem 1rem',
                  background: activeTab === 'mobile-money' ? '#f1f5f9' : 'transparent',
                  border: 'none',
                  borderRadius: '0.5rem',
                  cursor: 'pointer',
                  color: activeTab === 'mobile-money' ? '#1e293b' : '#64748b',
                  fontWeight: activeTab === 'mobile-money' ? 600 : 500,
                  transition: 'all 0.2s',
                  textAlign: 'left',
                  width: '100%'
                }}
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
              ...
              <div style={{
                ...
                >
                  ...
                  <span style={{ fontWeight: 600, color: '#1e293b', fontSize: '0.875rem' }}>M-Pesa</span>
                </button>
              </div>

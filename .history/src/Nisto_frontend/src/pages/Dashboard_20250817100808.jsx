        ...
        <header className="dashboard-header">
            ...
            <div className="header-page-indicator">
              ...
              <div className="page-info">
                ...
                <span className="page-subtitle">
                  {activeTab === 'overview' && 'Portfolio Overview & Analytics'}
                  {activeTab === 'wallets' && 'Manage Your Crypto Wallets'}
                  {activeTab === 'tokens' && 'Token Management & Trading'}
                  {activeTab === 'vaults' && 'Group Vaults & Shared Accounts'}
                  {activeTab === 'games' && 'Social Games & Rewards'}
                  {activeTab === 'ai' && 'AI Financial Assistant'}
                  {activeTab === 'payments' && 'Bill Payments & Transactions'}
                  {activeTab === 'recovery' && 'Security & Recovery Setup'}
                </span>
              </div>
            </div>
            ...
            <div className="quick-stats-bar">
              <div className="stat-item">
                ...
                <div className="stat-content">
                  <span className="stat-value">{formatBalance(userStats.totalBalance)}</span>
              ...
              <div className="stat-item">
                <span className="stat-icon">🔗</span>
                <div className="stat-content">
                  <span className="stat-value">{userStats.walletCount}</span>
              ...
              <div className="stat-item">
                <span className="stat-icon">🔐</span>
                <div className="stat-content">
                  <span className="stat-value">{userStats.recoveryMethodsCount}</span>
                  <span className="stat-label">Recovery Methods</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="dashboard-header-center">
            ...
            <div className="search-container">
              <div className="search-input-wrapper">
                ...
                <input 
                  type="text" 
                  placeholder="Search transactions, tokens, or wallets..." 
            ...
            <div className="quick-actions">
              <button className="quick-action-btn" title="Send Money">
                <FiSend />
                <span>Send</span>
              </button>
              <button className="quick-action-btn" title="Receive Money">
                <FiDownload />
                <span>Receive</span>
              </button>
              <button className="quick-action-btn" title="Swap Tokens">
                <FiRefreshCw />
                <span>Swap</span>
              </button>
              <button className="quick-action-btn" title="Add Funds">
                <FiPlus />
                <span>Add</span>
              </button>
            </div>
          ...
          <div className="dashboard-header-right">
            ...
            <div className="network-status">
              ...
              <span className="status-text">ICP Network</span>
            </div>
            ...
            <div className="market-ticker">
              <div className="ticker-item">
                ...
                <span className="ticker-price">$45,234</span>
                <span className="ticker-change positive">+2.4%</span>
              </div>
              <div className="ticker-item">
                <span className="ticker-symbol">ETH</span>
                <span className="ticker-price">$2,456</span>
                <span className="ticker-change negative">-1.2%</span>
              </div>
            </div>

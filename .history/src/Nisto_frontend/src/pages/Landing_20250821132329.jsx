...
function Landing() {
  ...
  const handleInstallExtension = () => {
    ...
    // Direct installation like MetaMask
    try {
      if (process.env.NODE_ENV === 'production') {
        ...
        // Development: Trigger Chrome's extension installation
        // This simulates the Chrome Web Store installation flow
      ...
      // Fallback to manual instructions if direct installation fails
      setExtensionModalOpen(true);
    }
  };

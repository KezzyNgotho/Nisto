...
import VaultInvitationTest from '../components/VaultInvitationTest';
    ...
    <div style={{
        ...
        <nav style={{ flex: 1, textAlign: 'left' }}>
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              ...
              <button
                onClick={() => setActiveTab('vault-invitation-test')}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: sidebarCollapsed ? '0' : '0.75rem',
                  padding: sidebarCollapsed ? '0.75rem' : '0.75rem 1rem',
                  background: activeTab === 'vault-invitation-test' ? `linear-gradient(135deg, ${theme.colors.primary}15 0%, ${theme.colors.primary}25 100%)` : 'transparent',
                  border: activeTab === 'vault-invitation-test' ? `1px solid ${theme.colors.primary}30` : '1px solid transparent',
                  borderRadius: '0.375rem',
                  cursor: 'pointer',
                  color: activeTab === 'vault-invitation-test' ? theme.colors.primary : theme.colors.text.secondary,
                  fontWeight: activeTab === 'vault-invitation-test' ? 600 : 500,
                  fontSize: '0.875rem',
                  transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)',
                  textAlign: sidebarCollapsed ? 'center' : 'left',
                  width: '100%',
                ...
                title={sidebarCollapsed ? 'Vault Invitation Test' : ''}
                onMouseEnter={(e) => {
                  if (activeTab !== 'vault-invitation-test') {
                    e.target.style.background = `${theme.colors.primary}10`;
                    e.target.style.borderColor = `${theme.colors.primary}20`;
                    e.target.style.color = theme.colors.primary;
                  }
              ...
              >
                <SafeIcon iconName="FiUserPlus" size={sidebarCollapsed ? 20 : 18} />
                {!sidebarCollapsed && 'Vault Invitation Test'}
              </button>
            </div>
          </div>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, padding: '1.5rem', overflowY: 'auto' }}>
          ...
          {activeTab === 'vault-invitation-test' && (
            <div style={{ width: '100%' }}>
              <VaultInvitationTest />
            </div>
          )}

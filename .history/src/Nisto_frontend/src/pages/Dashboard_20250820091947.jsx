    ...
    <div className="dashboard">
      ...
      <aside className="dashboard-sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <button className={`sidebar-link${activeTab==='profile'?' active':''}`} onClick={()=>setActiveTab('profile')}><FiUser /><span>Profile</span></button>
        </nav>
      ...
      <header className="dashboard-header">
          ...
          <div className="dashboard-header-right">
            {/* Username display and edit icon */}
            <button className="user-pill" disabled>
            ...
            {/* Edit profile/username icon */}
            <button className="logout-btn-header" onClick={()=>setActiveTab('profile')} title="Edit Profile"><FiUser /></button>
          </div>
      </header>
        {/* Main Content */}
        ...
        {activeTab === 'overview' && <Overview />}
          ...
          {activeTab === 'payments' && <PayBills auth={auth} backendService={auth.backendService} />}
          {activeTab === 'recovery' && <RecoverySetup />}
          {activeTab === 'profile' && <Profile />}
        </main>
        {/* Remove ProfileModal render */}

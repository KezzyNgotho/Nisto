...
function Landing() {
  ...
  return (
    <div className="landing-page" style={{ backgroundColor: theme.colors.background.primary }}>
      ...
      {/* Navigation */}
      <nav className="main-nav" style={{ backgroundColor: theme.colors.background.primary, borderBottom: `1px solid ${theme.colors.border.primary}` }}>
      ...
      <section id="home" className="hero-section" style={{ backgroundColor: theme.colors.background.secondary }}>
        <div className="hero-container">
          <div className="hero-content">
            <div className="hero-badge" style={{ backgroundColor: theme.colors.background.primary, padding: '8px 16px', borderRadius: '20px', display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '24px' }}>
            ...
            <div className="hero-actions" style={{ display: 'flex', gap: '16px' }}>
              ...
              <button 
                ...
                style={{ backgroundColor: theme.colors.background.primary, color: theme.colors.text.primary, border: `1px solid ${theme.colors.border.primary}`, borderRadius: '8px', padding: '12px 24px', fontSize: '14px', fontWeight: '500', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <svg className="btn-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 2C6.48 2 2 6.48 2 12S6.48 22 12 22 22 17.52 22 12 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12S7.59 4 12 4 20 7.59 20 12 16.41 20 12 20Z" fill="currentColor"/>
                  <path d="M12 6C8.69 6 6 8.69 6 12S8.69 18 12 18 18 15.31 18 12 15.31 6 12 6ZM12 16C9.79 16 8 14.21 8 12S9.79 8 12 8 16 9.79 16 12 14.21 16 12 16Z" fill="currentColor"/>
                </svg>
          ...
          <div className="hero-visual">
            <div className="hero-demo">
              <div className="demo-card" style={{ backgroundColor: theme.colors.background.primary, borderRadius: '12px', border: `1px solid ${theme.colors.border.primary}`, padding: '24px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
      ...
      <section id="features" className="features-section" style={{ backgroundColor: theme.colors.background.secondary }}>
        <div className="features-container">
          <div className="section-header">
            ...
            <div className="feature-card" style={{ backgroundColor: theme.colors.background.primary, padding: '24px', borderRadius: '12px', border: `1px solid ${theme.colors.border.primary}` }}>
      ...
      {/* Extension Section */}
      <section id="extension" className="extension-section" style={{ backgroundColor: theme.colors.background.primary }}>
              ...
              <div className="browser-mockup" style={{ backgroundColor: theme.colors.background.secondary, borderRadius: '12px', border: `1px solid ${theme.colors.border.primary}` }}>
                <div className="browser-header" style={{ backgroundColor: theme.colors.background.tertiary, padding: '12px', borderBottom: `1px solid ${theme.colors.border.primary}`, borderRadius: '12px 12px 0 0' }}>
                  <div className="browser-controls" style={{ display: 'flex', gap: '8px' }}>
                    <span className="control" style={{ width: '12px', height: '12px', borderRadius: '50%', backgroundColor: '#ff5f56' }}></span>
                    <span className="control" style={{ width: '12px', height: '12px', borderRadius: '50%', backgroundColor: '#ffbd2e' }}></span>
                    <span className="control" style={{ width: '12px', height: '12px', borderRadius: '50%', backgroundColor: '#27ca3f' }}></span>
                  </div>
                ...
                <div className="browser-content" style={{ padding: '24px' }}>
                  <div className="extension-popup" style={{ backgroundColor: theme.colors.background.primary, borderRadius: '8px', padding: '16px', border: `1px solid ${theme.colors.border.primary}` }}>
          ...
          <div className="tokenomics-content">
            <div className="tokenomics-overview">
              <div className="token-stats">
                <div className="stat-card" style={{ backgroundColor: theme.colors.background.primary, padding: '24px', borderRadius: '12px', border: `1px solid ${theme.colors.border.primary}`, textAlign: 'center' }}>
      ...
      {/* Airdrop Section */}
      <section className="airdrop-section" style={{ backgroundColor: theme.colors.background.primary }}>

        ...
        <div className="nav-container">
          <div className="nav-content">
            ...
            <div className="nav-links-desktop">
              ...
              <a href="/social-demo" className="nav-link" style={{ color: theme.colors.primary, fontSize: '14px', fontWeight: '600', textDecoration: 'none', marginRight: '24px' }}>🚀 Social Demo</a>
              {!isAuthenticated && (
      ...
      <section id="features" className="features-section" style={{ backgroundColor: theme.colors.background.secondary }}>
        <div className="features-container">
          <div className="section-header">
            ...
            <div className="feature-card" style={{ backgroundColor: theme.colors.background?.primary || theme.colors.background, padding: '24px', borderRadius: '12px', border: `1px solid ${theme.colors.border.primary}` }}>
              <div className="feature-icon" style={{ fontSize: '24px', color: theme.colors.primary }}>💬</div>
              <h3 className="feature-title" style={{ color: theme.colors.text.primary, fontSize: '18px', fontWeight: '600', marginTop: '16px' }}>Social Media Money Transfer</h3>
              <p className="feature-description" style={{ color: theme.colors.text.secondary, fontSize: '14px', fontWeight: '400', lineHeight: '1.5', marginTop: '8px' }}>
                Send money through Instagram, WhatsApp, Twitter, and more using natural language commands.
            </p>
            </div>
            
            <div className="feature-card" style={{ backgroundColor: theme.colors.background?.primary || theme.colors.background, padding: '24px', borderRadius: '12px', border: `1px solid ${theme.colors.border.primary}` }}>
              <div className="feature-icon" style={{ fontSize: '24px', color: theme.colors.primary }}>🚀</div>
              <h3 className="feature-title" style={{ color: theme.colors.text.primary, fontSize: '18px', fontWeight: '600', marginTop: '16px' }}>Social Integration Hub</h3>
              <p className="feature-description" style={{ color: theme.colors.text.secondary, fontSize: '14px', fontWeight: '400', lineHeight: '1.5', marginTop: '8px' }}>
                Make your wallet viral with influencer partnerships, viral campaigns, and cross-platform integration.
            </p>
            </div>
          </div>
        </div>

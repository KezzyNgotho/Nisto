...
function Landing() {
  ...
  return (
    <div className="landing-page" style={{ backgroundColor: theme.colors.background?.primary || theme.colors.background }}>
        ...
        <div className="nav-container">
          <div className="nav-content">
            ...
            <div className="nav-links-desktop">
              <a href="#hero" className="nav-link" style={{ color: theme.colors.text.secondary, fontSize: '14px', fontWeight: '500', textDecoration: 'none', marginRight: '24px' }}>Home</a>
      ...
      {/* Extension Section */}
      <section className="extension-section" style={{ backgroundColor: theme.colors.background?.primary || theme.colors.background }}>
      ...
      {/* Tokenomics Section */}
      <section className="tokenomics-section" style={{ backgroundColor: theme.colors.background.secondary }}>

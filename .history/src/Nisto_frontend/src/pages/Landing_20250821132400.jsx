...
function Landing() {
  ...
  const handleInstallExtension = () => {
    ...
    // Direct installation like MetaMask - seamless and immediate
    try {
      if (process.env.NODE_ENV === 'production') {
        ...
        // Development: Direct installation trigger
        // This simulates the MetaMask installation flow
        const extensionUrl = `${window.location.origin}/public/manifest-v3.json`;
        
        // Trigger Chrome's extension installation directly
        // This is how MetaMask does it - direct and seamless
        window.location.href = `chrome-extension://${extensionUrl}`;
        
        // If that doesn't work, try the Chrome Web Store approach
        setTimeout(() => {
          // Check if installation was successful
          if (!window.nesto) {
            // Fallback: Open Chrome Web Store or show minimal instructions
            const fallbackUrl = 'https://chrome.google.com/webstore/category/extensions';
      ...
      // Minimal fallback - just a simple alert, no modal

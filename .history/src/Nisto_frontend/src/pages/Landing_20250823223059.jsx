...
function Landing() {
  ...
  return (
    <div className="landing-page" style={{ backgroundColor: '#0a0f1c', minHeight: '100vh' }}>
      <ThemeSwitcher />
      
      {/* Navigation */}
      <nav className="main-nav" style={{ 
        background: 'linear-gradient(135deg, rgba(17, 63, 103, 0.95) 0%, rgba(10, 15, 28, 0.98) 100%)',
          ...
          <div className="nav-content">
            <div className="nav-brand">
              <div className="brand-logo" style={{ 
                ...
                <span className="logo-text" style={{ color: '#ffffff', fontSize: '18px', fontWeight: '700', textShadow: '0 1px 2px rgba(0,0,0,0.3)' }}>N</span>
              </div>
      ...
      <section id="home" className="hero-section" style={{ 
        ...
        <div style={{
          ...
          right: 0,
          bottom: 0,
          background: 'radial-gradient(circle at 20% 80%, rgba(17, 63, 103, 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(24, 144, 255, 0.2) 0%, transparent 50%)',
        ...
        <div className="hero-container" style={{ position: 'relative', zIndex: 2 }}>
          <div className="hero-content">
            <div className="hero-badge" style={{ 
              background: 'linear-gradient(135deg, rgba(17, 63, 103, 0.9) 0%, rgba(24, 144, 255, 0.8) 100%)',
              padding: '12px 24px',
              borderRadius: '50px',
              display: 'inline-flex',
              alignItems: 'center',
              ...
              boxShadow: '0 8px 32px rgba(17, 63, 103, 0.3)'
            }}>
              ...
              <span style={{ color: '#ffffff', fontSize: '14px', fontWeight: '600', textShadow: '0 1px 2px rgba(0,0,0,0.3)' }}>🚀 Live on Internet Computer</span>
            </div>
            ...
            <div className="hero-actions" style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
              ...
              <div className="hero-demo">
                <div className="demo-card" style={{ 
                  ...
                  border: '1px solid rgba(255, 255, 255, 0.2)',
                  padding: '32px',
                  boxShadow: '0 20px 60px rgba(0, 0, 0, 0.3), 0 8px 32px rgba(17, 63, 103, 0.2)',
                  backdropFilter: 'blur(20px)',
                  position: 'relative',
                  overflow: 'hidden'
                }}>
      ...
      <section id="features" className="features-section" style={{ 
        ...
        <div style={{
          ...
          right: 0,
          bottom: 0,
          background: 'radial-gradient(circle at 25% 25%, rgba(17, 63, 103, 0.1) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(24, 144, 255, 0.1) 0%, transparent 50%)',
          opacity: 0.6
        }}></div>
      ...
      {/* CTA Section */}
      <section className="cta-section" style={{ backgroundColor: theme.colors.background?.primary || theme.colors.background }}>

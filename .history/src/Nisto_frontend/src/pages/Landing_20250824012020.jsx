...
function Landing() {
  ...
  useEffect(() => {
    console.log('Landing useEffect - isAuthenticated:', isAuthenticated, 'isLoading:', isLoading);
    if (isAuthenticated && !isLoading) {
      console.log('User is authenticated and not loading, navigating to dashboard...');
      navigate('/dashboard');
    }
  }, [isAuthenticated, isLoading, navigate]);

  const handleLaunchApp = () => {
    console.log('🚀 Launch App clicked - isAuthenticated:', isAuthenticated, 'isLoading:', isLoading);
    ...
    if (isAuthenticated) {
      ...
      console.error('❌ Error in handleLaunchApp:', error);

        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              <span className="title-line" style={{ color: theme.colors.text.primary, fontSize: '32px', fontWeight: '700', lineHeight: '1.2' }}>The Future of</span>
              <span className="title-line gradient-text" style={{ fontSize: '32px', fontWeight: '700', lineHeight: '1.2' }}>Social Finance</span>
            </h1>
            <p className="hero-subtitle" style={{ color: theme.colors.text.secondary, fontSize: '16px', fontWeight: '400', lineHeight: '1.5' }}>

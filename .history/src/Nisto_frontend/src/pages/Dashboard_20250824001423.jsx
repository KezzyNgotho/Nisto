  ...
  return (
    <div style={{
      ...
      <aside 
        ...
        className={`dashboard-sidebar ${mobileMenuOpen ? 'mobile-open' : ''} ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}
      ...
      {/* Main Content */}
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column' }} className="dashboard-main-content">
        {/* Header */}
        <header style={{
          background: theme.colors.white,
        ...
        <div style={{ flex: 1, padding: '1.5rem', overflowY: 'auto' }}>
          {activeTab === 'overview' && (
            <div className="overview-component" style={{ width: '100%' }}>
              {/* Balance Card */}
              <div className="overview-balance-card dashboard-card" style={{
                background: `linear-gradient(135deg, ${theme.colors.primary} 0%, ${theme.colors.interactive.hover} 100%)`,
                borderRadius: '1rem',
                padding: '2rem',
                color: theme.colors.white,
              ...
              {/* Quick Actions */}
              <div className="overview-quick-actions dashboard-grid" style={{
                display: 'grid',
                ...
                <button
                  className="overview-action-btn dashboard-btn"
                  onClick={() => {
              ...
              {/* Wallet Summary */}
              <div className="overview-wallet-summary dashboard-card" style={{
                background: theme.colors.white,
                border: `1px solid ${theme.colors.border.primary}`,
                borderRadius: '0.75rem',
                padding: '1.5rem',
                ...
                <div className="overview-wallet-header" style={{
                  display: 'flex',
                  justifyContent: 'space-between',
                  alignItems: 'center',
                  marginBottom: '1rem'
                }}>
                  <h3 className="overview-wallet-title" style={{ margin: 0, fontSize: '1rem', fontWeight: 600, color: theme.colors.text.primary }}>
                    Your Wallets
                  </h3>
                  <button
                    className="overview-view-all-btn dashboard-btn"
                    onClick={() => setActiveTab('wallets')}
                    style={{
                      background: 'none',
                      border: 'none',
                ...
                {cryptoWallets && cryptoWallets.length > 0 ? (
                  <div className="overview-wallet-list dashboard-list" style={{ display: 'grid', gap: '0.75rem' }}>
                    {cryptoWallets.slice(0, 3).map((wallet) => (
                      <div key={wallet.id} className="overview-wallet-item dashboard-list-item" style={{
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'space-between',
                        padding: '0.75rem',

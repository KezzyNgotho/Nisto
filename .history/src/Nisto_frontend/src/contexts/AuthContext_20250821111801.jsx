...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      try {
        ...
        console.log('BackendService initialized successfully:', initResult);
      } catch (e) {
  ...
  const generateUsername = useCallback(async () => {
    ...
    try {
      const principalText = backend.principal ? backend.principal.toString() : '';
      ...
      const updateResult = await backend.updateUser(generated, null);

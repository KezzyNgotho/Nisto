...
import { idlFactory } from '../../../declarations/SwapService';
  ...
  async initialize() {
    ...
    try {
      ...
      const canisterId = process.env.NODE_ENV === 'development'
        ? process.env.REACT_APP_SWAP_SERVICE_CANISTER_ID || 'rrkah-fqaaa-aaaah-qcvmq-cai'
        : process.env.REACT_APP_SWAP_SERVICE_CANISTER_ID;
      ...
      console.log('SwapBackendService initialized with canister:', canisterId);
    } catch (error) {

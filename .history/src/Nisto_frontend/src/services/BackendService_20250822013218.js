...
// Import idlFactory with error handling
let idlFactory;
try {
  idlFactory = (await import('../../../declarations/Nisto_backend/Nisto_backend.did.js')).idlFactory;
} catch (error) {
  console.warn('BackendService: Could not import idlFactory, using fallback:', error);
  // Fallback idlFactory - this will be replaced when dfx generate runs
  idlFactory = null;
}

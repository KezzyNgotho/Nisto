...
class BackendService {
  ...
  async getDarajaAccessToken() {
    try {
      const consumerKey = 'I9LNXzDGLnuFgRyvvaG33rozQS6f5qwpJYAO00mRE3DkKJwu';
      const consumerSecret = 'qwnqdh7obp0t9z06Oj6trOPkB8VlU9W7I30rdI09ElyGerJ3Acq8Nu0SCIGBvlUB';

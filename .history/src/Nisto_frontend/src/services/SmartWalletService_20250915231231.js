...
class SmartWalletService {
  ...
  // Initialize the SmartWallet actor
  async initialize() {
    if (this.isInitialized) return;
    
    try {
      // Import the SmartWallet actor (generated by dfx)
      const { SmartWallet } = await import('../../../declarations/SmartWallet');
      this.actor = SmartWallet;
      this.isInitialized = true;
      console.log('✅ SmartWalletService: Actor initialized successfully');
    } catch (error) {
  ...
  async saveUserPreferences(userId, preferences) {
    ...
    return await this.actor.saveUserPreferences(userId, preferences);
  }

  async getUserPreferences(userId) {
    await this.initialize();
    return await this.actor.getUserPreferences(userId);
  }

  async updateUserPreferences(userId, preferences) {
    await this.initialize();
    return await this.actor.updateUserPreferences(userId, preferences);
  }

  // Swap Record Management
  async addSwapRecord(userId, swapData) {
    await this.initialize();
    return await this.actor.addSwapRecord(userId, swapData);
  }

  async getSwapHistory(userId) {
    await this.initialize();
    return await this.actor.getSwapHistory(userId);
  }

    ...
    try {
      ...
      if (typeof userId === 'string') {
        try {
          ...
          // For now, we'll use the caller's principal as a placeholder
          // In a real implementation, you'd convert the string to a Principal
          console.warn('Using caller principal as placeholder for invited user');
        } catch (e) {

...
class BackendService {
  ...
  async getUserNotifications(limit = 20, offset = 0) {
    try {
      ...
      // Don't use JSON.stringify on result as it may contain BigInt values
      console.log('BackendService: Result structure:', result);
      
      // Handle BigInt serialization issues by converting to safe format

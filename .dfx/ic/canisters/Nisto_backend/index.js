...
import { idlFactory } from './Nisto_backend.did.js';
export { idlFactory } from './Nisto_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NISTO_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Nisto_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Nisto_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Nisto_backend.did.js")._SERVICE>}
 */
export const Nisto_backend = createActor(canisterId);

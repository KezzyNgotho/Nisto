...
import { idlFactory } from './Nesto_frontend.did.js';
export { idlFactory } from './Nesto_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NESTO_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Nesto_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Nesto_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Nesto_frontend.did.js")._SERVICE>}
 */
export const Nesto_frontend = createActor(canisterId);

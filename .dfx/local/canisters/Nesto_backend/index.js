...
import { idlFactory } from './Nesto_backend.did.js';
export { idlFactory } from './Nesto_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NESTO_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Nesto_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Nesto_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Nesto_backend.did.js")._SERVICE>}
 */
export const Nesto_backend = createActor(canisterId);

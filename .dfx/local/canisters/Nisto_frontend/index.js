...
import { idlFactory } from './Nisto_frontend.did.js';
export { idlFactory } from './Nisto_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NISTO_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Nisto_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Nisto_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Nisto_frontend.did.js")._SERVICE>}
 */
export const Nisto_frontend = createActor(canisterId);

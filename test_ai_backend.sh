...
/home/kezzy/.local/share/dfx/bin//home/kezzy/.local/share/dfx/bin/dfx canister call Nisto_backend saveAIUserPreferences '("test_user_123", record {
...
/home/kezzy/.local/share/dfx/bin/dfx canister call Nisto_backend getAIUserPreferences '("test_user_123")'

echo ""

# Test 3: Test Portfolio Analysis
echo "🔍 Test 3: Testing AI Portfolio Analysis..."
/home/kezzy/.local/share/dfx/bin/dfx canister call Nisto_backend analyzePortfolioAndSwap '("test_user_123", vec {
  record {
    symbol = "BTC";
    amount = 0.1;
    value = 4500.0;
...
/home/kezzy/.local/share/dfx/bin/dfx canister call Nisto_backend addAISwapRecord '("test_user_123", "BTC", "USDC", 0.05, 45000.0, "AI detected high volatility, hedging position", "completed", null, vec {"BTC -> USDC"}, 0, null, opt 0.001, "auto_hedge", "auto")'

echo ""

# Test 5: Get AI Swap History
echo "📈 Test 5: Getting AI Swap History..."
/home/kezzy/.local/share/dfx/bin/dfx canister call Nisto_backend getAISwapHistory '("test_user_123")'

echo ""

# Test 6: Get All AI User IDs
echo "👥 Test 6: Getting All AI User IDs..."
/home/kezzy/.local/share/dfx/bin/dfx canister call Nisto_backend getAllAIUserIds
